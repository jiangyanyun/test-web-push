!(function t(e, r, n) {
...
})(
  {
            ...
            return (
              ...
              (t.prototype.config = function (t) {
                ...
                for (e in t)
                  (n = t[e]),
                    "scheme" === e
                      ? this.setTrackerScheme(n)
                      : "sampling" === e
                      ? this.setSampling.apply(this, n)
                      : (this.options[e] = n);
                r = [];
                for (e in this.options)
                  r.push((window.vds[e] = this.options[e]));
                return r;
              }),
              ...
              (t.prototype.setUid = function () {
                return this.options.host
                  ? d.sendRequest("https://" + this.options.host + "/touch")
                  : void 0;
              }),
          ...
          (n = (function () {
            function t(t, e, r, n) {
              (this.launcher = t),
                ...
                (this.utils = i),
                this.bindPageChangeEvent();
            }
            return (
              (t.prototype.bindPageChangeEvent = function () {
                return (
                  this.utils.bind(window, "popstate", this.pageChanged, !0),
                  window.vds.hashtag
                    ? this.utils.bind(
                        window,
                        "hashchange",
    ...
    4: [
              ...
              (e.prototype.set = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["evar.set"].concat(d.call(arguments))
                  );
                if (
                  1 === arguments.length &&
                  this.utils.isObject(arguments[0]) &&
      ...
      { "../tools/utils": 16, "./base_dimension": 3 },
    ],
    5: [
      function (t, e, r) {
        var n,
          ...
          (i = (function (t) {
            function e() {
              (this.setPS = s(this.setPS, this)),
                ...
                (this.set = s(this.set, this)),
                (this.sendPvListener = s(this.sendPvListener, this)),
                e.__super__.constructor.apply(this, arguments),
                (this.properties = {}),
                (this.pageService = this.observer.pageService),
                (this.currentUrl = ""),
                (this.pvarCache = {}),
                this.pageService.registerSendPvListener(this.sendPvListener);
            }
            return (
              a(e, t),
              (e.prototype.sendPvListener = function (t) {
                var e, r, n, i;
              ...
              (e.prototype.set = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["page.set"].concat(d.call(arguments))
                  );
                if (
                  1 === arguments.length &&
                  this.utils.isObject(arguments[0]) &&
                      ...
                      (function (t) {
                        return function () {
                          ...
                          return (
                            ...
                            t.pageService.pagePath &&
                            e.p !== t.pageService.pagePath
                              ? ((r = t.pvarCache[e.p]),
                                null == r && (r = []),
                                r.push(e),
                                void (t.pvarCache[e.p] = r))
                              : t.send([e], "pvar")
                          );
                        };
                      })(this),
          ...
          (i = (function (t) {
            ...
            return (
              ...
              (e.prototype.set = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["people.set"].concat(d.call(arguments))
                  );
                if (
                  arguments.length > 1 &&
                  this.utils.isString(arguments[0]) &&
              ...
              (e.prototype.setId = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["people.setId"].concat(d.call(arguments))
                  );
                if (
                  t &&
                  window.vds.accountId &&
                  this.getId() !== t &&
                  !this.gruser.isHybrid
                )
                  return (
                    this.people_cache && this.set(this.people_cache),
                    (n = this.gruser.lastSessionId),
                    (r = this.gruser.sid()),
                    (e = s = !0),
                    (i = this.gruser.last_sent_sid_with_cs1()),
                    this.getId() &&
                      this.getId() !== t &&
                      ((r = this.gruser.guid()), (s = !1)),
                    r === n &&
                      i === r &&
                    ...
                    (o = i && i === r),
                    this.gruser.updateSessionId(r, o),
                    setTimeout(
                      (function (t) {
                        return function () {
                          return (
                            t.observer.pageService.sendPV(
                              { addPreProps: e, useNewTime: s },
    ...
    8: [
            ...
            return (
              (t.prototype.path = function (t, e) {
                ...
                for (
                    ...
                    (r.hasIdx()
                      ...
                      : ((N = r.path()),
                        (-1 !== N.indexOf("/dl") ||
                          -1 !== N.indexOf("/tr") ||
                          -1 !== N.indexOf("/li")) &&
                          ((l = !0), (h = this.index(r.node))))),
                  (y = r.node.parentNode),
                  e &&
                    "" !== s &&
                    (-1 !== u.indexOf(a, r.node.tagName) || r.isContainer()) &&
                    (p
                      ? (n.obj = c)
                  ...
                  (r = new i(y)), 1 === d && (_ = r.node);
                for (b.reverse(), f = 0, v = o.length; v > f; f++)
                  (w = o[f]),
                    (w.x = b.slice(0, d - w.x).join("")),
                    l && (w.idx = h),
                    p && (w.obj = c);
                return (
                  (C = { xpath: s, containerMessage: o, isIgnore: g }),
                  p && (C.obj = c),
                  l && (C.idx = h),
                  _ && (C.pnode = _),
                  C
                ...
                if ("BUTTON" === t.tagName) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      return e.length <= 50 ? e : e.slice(0, 50);
                  } else if (
                    u.hasAttr(t, "href") &&
      ...
      { "../tools/utils": 16, "./tagging_node_info": 10 },
    ],
    9: [
      function (t, e, r) {
        var n, i, o, s;
      ...
      { "../tools/guid": 14, "../tools/utils": 16, "../vendor/cookie": 17 },
    ],
    10: [
      function (t, e, r) {
        var n, i, o, s;
          ...
          (n = (function () {
            function t(t, e, r, n) {
              (this.sender = t),
                ...
                (this.launcher = r),
                (this.TreeMirror = n),
                (this.setPSForActionMessage = d(
                  this.setPSForActionMessage,
                  this
                )),
                (this.pageChanged = d(this.pageChanged, this)),
                (this.sendPageCallback = d(this.sendPageCallback, this)),
                (this.content = {}),
                (this.pageService = new o(
                  this.sender,
                  this.gruser,
                  this.launcher
                ));
            ...
            return (
              ...
              (t.prototype.sendPageCallback = function (t) {
                return (
                  ...
                  (this.prevPageAttrs = u.assignObj({}, t.preProperties)),
                        ...
                        return function (e, n, i, o) {
                          ...
                          if (
                            ...
                            for (
                              ...
                              (l = n[d]),
                                (a = a.concat(t.getLeafNodes(l, l.length)));
                            if (((c.e = a), a.length > 0))
                              return t.sendPolicy(c);
                          }
                        };
                      })(this),
                    }),
                    this.TreeMirror
                      ? (this.client = r = new this.TreeMirror.Client(
                          document.body,
                          t
                        ))
                      : void 0
              ...
              (t.prototype.idle = function () {
                return (
                  ...
                  this.lastSentTime &&
                    (+Date.now() - this.lastSentTime) / c.length > 300
                );
              }),
              ...
              (t.prototype.getLeafNodes = function (t, e) {
                ...
                if (((o = []), (d = !0), t.leaf))
                  1 === t.nodeType &&
                    ((null != (h = t.attributes) ? h.href : void 0) ||
                      null != t.text ||
                      null != t.obj) &&
                    ((a = this.nodeMessage(t, !0)),
                    e > 1 && (a.idx = t.idx),
                    o.push(a));
                else if (
                  0 === t.childNodes.length &&
                  -1 === u.indexOf(w, t.tagName)
                );
                else {
                  for (c = t.childNodes, i = 0, s = c.length; s > i; i++)
                    (r = c[i]),
                      r.leaf || (d = !1),
                      (o = o.concat(this.getLeafNodes(r, t.childNodes.length)));
                  (-1 !== u.indexOf(g, t.tagName) ||
                    (d &&
                      ((null != (l = t.attributes) ? l.any : void 0) ||
                        t.text))) &&
                    (t.text ||
                      ((n = t.dom),
                      (t.text = n
                        ? this.info.containerElemContent(n)
                        : u.parentOfLeafText(t))),
                    (a = this.nodeMessage(t, !1)),
                    o.push(a));
                }
                return o;
              }),
              (t.prototype.nodeMessage = function (t, e) {
                ...
                return (
                  ...
                  (null != (s = t.text) ? s.length : void 0) > 50 &&
                    (i.v = "A" === t.tagName ? t.text.slice(0, 50) : void 0),
                  (n = t.attributes) &&
                    n.href &&
                    0 !== n.href.indexOf("javascript") &&
                    ((i.h = u.normalizePath(n.href.slice(0, 320))),
                    delete t.attributes.href),
                  t.idx && (i.idx = t.idx),
                  t.obj && (i.obj = t.obj),
                  this.appendMessageAttrs(r, i, t)
                );
              }),
              ...
              (t.prototype.registerEventListener = function () {
                ...
                (a = {
                  ...
                  (c = function (t) {
                    ...
                    return (
                      (e = +Date.now() - l.time),
                      250 > e && n.adx < 20 && n.ady < 20
                        ? ((r = { target: l.target, type: "click" }), s(r))
                        : void 0
                    );
                  }),
                  (i = function () {
                    ...
                    "ontouchstart" in window &&
                      ...
                      (u = ["touchmove"]));
                    for (e = 0, o = p.length; o > e; e++)
                      (t = p[e]), r(document, t, h);
                    for (n = 0, s = u.length; s > n; n++)
                      (t = u[n]), r(document, t, d);
                    for (l = [], i = 0, a = f.length; a > i; i++)
                      (t = f[i]), l.push(r(document, t, c));
                    return l;
                  }),
                  (s = (function (t) {
                    return function (r) {
                      ...
                      if (!document.body.className.match(/\bvds-entrytext\b/)) {
                        ...
                        if (((h = c.tagName), "click" === r.type)) {
                          ...
                          if ("INPUT" === h && -1 === u.indexOf(m, c.type))
                            return;
                          if (
                            -1 === u.indexOf(w, h) &&
                            !t.info.depthInside(c, 4)
                          )
                            return;
                        }
                        return (
                          ...
                          (d = "snapshot" === r.type),
                          d && (r.type = "click"),
                          (o = t.compute(d ? "click" : r.type, c)),
                          t.appendElemAttrs(o, d, c, n),
                          (o.x = n.xpath),
                          n.obj && (o.obj = n.obj),
                          n.idx
                            ? (o.idx = n.idx)
                            : (-1 !== o.x.indexOf("/dl") ||
                                -1 !== o.x.indexOf("/tr") ||
                                -1 !== o.x.indexOf("/li")) &&
                              (o.idx = t.info.index(c)),
                          (s.e =
                            0 === n.containerMessage.length
                              ? [o]
                              : -1 !== u.indexOf(g, n.pnode.tagName) &&
                                t.info.onlyContainsChildren(n.pnode, f)
                              ? n.containerMessage
                              : [o].concat(n.containerMessage)),
                          d
                            ? ((s.isTrackingEditText = !(
                                "INPUT" !== h && "SELECT" !== h
                              )),
                              t.snapshotCallback(r, s))
                            : t.sender.send([s])
                        );
                      }
                    };
                ...
                return "boolean" == typeof window.hybridEnableTouch &&
                  window.hybridEnableTouch
                  ? i()
                  : void 0;
              }),
              ...
              (t.prototype.compute = function (t, e) {
                ...
                if (
                  ...
                  (O = e.tagName),
                  "IMG" === O
                    ? (null != (S = e.src) ? S.length : void 0) > 0 &&
                    ...
                    : u.hasAttr(e, "href") &&
                      ...
                      o &&
                        ...
                        (i.h = u.normalizePath(o.slice(0, 320)))),
                  u.hasAttr(e, "data-growing-title") &&
                    e.getAttribute("data-growing-title").length > 0)
                )
                  i.v = e.getAttribute("data-growing-title");
                else if (
                  u.hasAttr(e, "title") &&
                  e.getAttribute("title").length > 0
                )
                  i.v = e.getAttribute("title");
                else if ("click" === t)
                    ...
                    if ("IMG" === O)
                      e.alt
                        ...
                        : i.h &&
                          ((d = i.h.split("?")[0]),
                          (a = d.split("/")),
                          a.length > 0 && (i.v = a[a.length - 1]));
                    else if ("INPUT" === O && -1 !== u.indexOf(m, e.type))
                      i.v = e.value;
                    else if ("svg" === O)
                      for (E = e.childNodes, s = 0, _ = E.length; _ > s; s++)
                        (r = E[s]),
                          1 === r.nodeType &&
                            "use" === r.tagName &&
                            u.hasAttr(r, "xlink:href") &&
                            (i.v = r.getAttribute("xlink:href"));
                    else
                      (I = ""),
                        null != e.textContent
                          ? (I = e.textContent.replace(/[\n \t]+/g, " ").trim())
                          : null != e.innerText &&
                            (I = e.innerText.replace(/[\n \t]+/g, " ").trim()),
                        I.length > 0 &&
                          (I.length < 50
                            ? (i.v = I)
                            : "A" === O && (i.v = I.slice(0, 50)));
                  else
                    -1 !== u.indexOf(g, O)
                      ? ((n = this.info.containerElemContent(e)),
                        this.info.isParentOfLeaf(e) &&
                        !this.info.onlyContainsChildren(e, f)
                          ? ((N = u.parentOfLeafText(e)),
                            N === n
                              ? (i.v = n)
                              : ((i.v = N), (i.obj = n || "")))
                          : (i.v = n))
                      : this.info.isParentOfLeaf(e) &&
                        (i.v = u.parentOfLeafText(e));
                else if ("change" === t)
                  "TEXTAREA" !== O &&
                    ("INPUT" === O
                      ? -1 !== u.indexOf(p, e.type)
                        ? ((i.v = e.value),
                          (l = e.parentNode),
                          "LABEL" === l.tagName
                            ? (c = l)
                            : "BODY" !== l.tagName &&
                              ...
                              "LABEL" === l.tagName
                                ? (c = l)
                                : e.id &&
                                  ((b = l.getElementsByTagName("label")),
                                  (function () {
                                    var t, r, n;
                                    for (
                                      n = [], t = 0, r = b.length;
                                      ...
                                      (y = b[t]), n.push(y["for"] === e.id);
                                    return n;
                                  })() && (c = y))),
                          null != c &&
                            ((v = this.info.containerElemContent(c)),
                            (null != v ? v.length : void 0) > 0 &&
                              (i.v = v + " (" + e.checked + ")")))
                        : "password" !== e.type &&
                          (u.hasAttr(e, "growing-track") ||
                            u.hasAttr(e, "data-growing-track")) &&
                          (i.v = e.value)
                      : "SELECT" === O &&
                        ((i.v = e.value),
                        1 === e.selectedOptions.length &&
                          null != e.selectedOptions[0].label &&
                          (i.v = e.selectedOptions[0].label)));
                else if ("submit" === t)
                  for (
                    x = e.getElementsByTagName("input"), w = 0, C = x.length;
                    C > w;
                    w++
                  )
                    (h = x[w]),
                      ("search" === h.type ||
                        ("text" === h.type &&
                          ("q" === h.id ||
                            -1 !== h.id.indexOf("search") ||
                            -1 !== h.className.indexOf("search") ||
                            "q" === h.name ||
                            -1 !== h.name.indexOf("search")))) &&
                        ((i.x = this.info.path(h).xpath),
                        (i.v = h.value.trim()));
                return i;
              }),
              ...
              (t.prototype.registerHistoryHandler = function () {
                ...
                return (
                  ...
                  null != t &&
                    ((this.prevUrl = u.getDocumentReferrer()),
                    ...
                    u.bind(window, "popstate", this.pageChanged, !0)),
                  window.vds.hashtag
                    ? u.bind(window, "hashchange", this.pageChanged, !0)
                    : void 0
                );
              }),
              ...
              (t.prototype.domLoadedHandler = function (t) {
                ...
                if (!this.domLoadedHandler.done) {
                  if (
                    ...
                    null != this.TreeMirror && window.vds.imp)
                  ) {
              ...
              (t.prototype.loadPlugin = function (t) {
                ...
                return this.pluginLoaded
                  ...
                  : ((s = t.add_on_grSource.add_on_origin),
                    ...
                    (e.charset = "UTF-8"),
                    (e.src = s + "/assets/javascripts/outer-circle-plugin.js"),
          ...
          (n = (function () {
            function t() {
              (this.registerInnerIframe = a(this.registerInnerIframe, this)),
                ...
                (this.notifyInnerIframes = a(this.notifyInnerIframes, this)),
            ...
            return (
                ...
                return s.bind(
                  ...
                  (function (t) {
                    return function (e) {
                      ...
                      if (
                        ((n = e.data),
                        n.ai === window.vds.accountId &&
                          ((h = n.mode || n.circleMode),
                          t.isSdkEvent(h) && (!n.fsna || "sdk" === n.fsna)))
                      ) {
                        if ("grcw-inner-iframe" === n.sna)
                          return void parent.postMessage(e.data, "*");
                        if (((c = n.mode), u.call(o, c) >= 0))
                          s.spreadToInnerIframes(n);
                        else if (
                          n.tna !== window.grSource.name &&
                          n.tna &&
                          n.tid
                        ) {
                          for (
                            ...
                            (a = r[i]), t.notifyInnerIframes(a, n);
                          return;
                        }
                        if (
                          ((l = n.mode),
              ...
              (t.prototype.notifyInnerIframes = function (t, e) {
                var r;
                return (
                  (r = t.contentWindow), r ? r.postMessage(e, "*") : void 0
                );
              }),
              ...
              (t.prototype.sendPageLoad = function (t) {
                ...
                return (
                  null == t && (t = null),
                  (n = (null != (r = window.vds) ? r.pathCaseSensitive : void 0)
            ...
            return (
              ...
              (t.prototype.sendPV = function (t, e) {
                ...
                return (
                  ...
                  this.options.sendVisit &&
                    this.gruser.isSendNewVisit() &&
    ...
    16: [
        ...
        (o = t("./guid")),
          ...
          (s = {
            ...
            domain: function () {
              return window._vds_ios
                ? !window.location.protocol ||
                  ...
                  ? window.location.host || window.vds.accountId
                  : window.location.host
                  ? ""
                  : window.vds.accountId
                : window.location.host || window.vds.accountId;
            ...
            getWindowSourceName: function () {
              var t, e;
              return (
                (e = null != window.self.name ? window.self.name : window.name),
                e &&
                  window.nameStorage &&
                  ((t = e.split(/[:?]/)),
            ...
            parentOfLeafText: function (t) {
              ...
              for (s = t.childNodes, i = 0, o = s.length; o > i; i++)
                (e = s[i]),
                  3 === e.nodeType &&
                    (null != e.textContent
              ...
              return (
                (n = n.replace(/[\n \t]+/g, " ").trim()),
                n.length > 0 && n.length < 50 ? n : void 0
              );
            },
              ...
              if (((n = null), null != t))
                for (r in t)
                  if (
                    ...
                    (n[e] = i),
                    Object.getOwnPropertyNames(n).length >= 100)
                  )
                    return n;
              return n;
            },
      ...
      { "../vendor/cookie": 17, "./guid": 14, "./local_store": 15 },
    ],
    17: [
      function (t, e, r) {
        ...
        var c = (function () {
            ...
            return (
              ...
              (t.prototype.getChanged = function (t, e, r) {
                ...
                for (var s = this.stayedIn.keys(), n = 0; n < s.length; n++) {
                  ...
                  if (o === d.ENTERED) t.added.push(i);
                    ...
                    t.reparented && a === d.REPARENTED
                      ? t.reparented.push(i)
                      : t.reordered && a === d.REORDERED && t.reordered.push(i);
                  }
                }
              ...
              (t.prototype.attributeChangedNodes = function (t) {
                ...
                for (
                  ...
                  if (
                    ...
                    for (
                      var h = a, c = u.getAttributeNamesMutated(), l = 0;
                      l < c.length;
                      l++
                    ) {
                      var i = c[l];
              ...
              (t.prototype.computeMatchabilityChange = function (t, e) {
                this.matchCache || (this.matchCache = []),
                  this.matchCache[t.uid] || (this.matchCache[t.uid] = new h());
              ...
              (t.parseSelectors = function (e) {
                ...
                for (
                  var i,
                    ...
                    a = [],
                    u = /\s/,
                    d = "Invalid or unsupported selector syntax.",
                    h = 1,
                    c = 2,
                    l = 3,
                    p = 4,
                  ...
                  switch (O) {
                    ...
                    case c:
                      ...
                      if ("." == A) {
                        n(), (o.attrName = "class"), (o.contains = !0), (O = p);
                        break;
                      }
                      if ("#" == A) {
                        n(), (o.attrName = "id"), (O = p);
          ...
          _ = (function () {
            ...
            return (
              ...
              (t.validateOptions = function (e) {
                ...
                for (
                  ...
                  if (a.all) {
                    ...
                    if (
                      ((u.elementFilter = y.parseSelectors(
                        "*[" + u.attribute + "]"
                      )),
                    ...
                    if (
                      (a.hasOwnProperty("elementAttributes") &&
                        ((u.attributeList = o(a.elementAttributes)), d--),
                      d > 1)
                    )
                      throw Error(
              ...
              (t.NodeMap = h),
              (t.parseElementFilter = y.parseSelectors),
              (t.optionKeys = {
                callback: !0,
                queries: !0,
                rootNode: !0,
        ...
        var n = {
          ...
          d = (function () {
            function t(t, e, r) {
              ...
              var a = [
                { element: "*" },
                { element: "*", elementAttributes: "data-growing-title src" },
              ];
              r && (a = a.concat(r)),
              ...
              (t.prototype.serializeNode = function (t, e, r, d) {
                ...
                if (void 0 === e) {
                  ...
                  for (
                    ...
                    h && "BODY" !== h.tagName && "HTML" !== h.tagName;

                  ) {
                    var c = "/" + h.tagName.toLowerCase(),
                      l = h.getAttribute("id");
                    if (
                      (l && null === l.match(/^[0-9]/) && (c += "#" + l),
                      ...
                      for (var x = w.firstChild; x; x = x.nextSibling) {
                        if (
                          ((_ = w.hasAttribute("data-growing-info")
                            ...
                            : null),
                          (C = w.hasAttribute("data-growing-idx")
                          ...
                          if (
                            x.hasAttribute("growing-ignore") ||
                            x.hasAttribute("data-growing-ignore")
                          )
                            continue;
                          ...
                          -1 !== i.indexOf(x.tagName) && ((N += 1), (C = N)),
                            x.hasAttribute("data-growing-idx") &&
                              ((N = parseInt(
                                x.getAttribute("data-growing-idx")
                              )),
                              (C = N)),
                            x.hasAttribute("data-growing-info") &&
                              (_ = x.getAttribute("data-growing-info"));
                        }
                        var O = this.serializeNode(
                          x,
                          e,
                          N > 0 && C > 0 ? N : r,
                          _ || d
                        );
                        if (null === O) 3 != x.nodeType && (b = !1);
                    ...
                    if (b)
                      ...
                      w.getAttribute("data-growing-title").length > 0
                        ...
                        w.hasAttribute("data-growing-idx") &&
                          (g.idx = parseInt(
                            w.getAttribute("data-growing-idx")
                          )),
    ...
    22: [
      function (t, e, r) {
        ...
        (i = window._vds_ios),
          i &&
            ((h =
              null != (a = window.webkit) && null != (u = a.messageHandlers)
                ? u.GrowingIO_WKWebView
                : void 0),
            (d = !h)),
          (o = window._vds_bridge ? !0 : void 0),
          (s = i ? !0 : void 0),
          (n = window._vds_bridge || i),
          (e.exports = {
            isAndroid: o,
            isiOS: i,
            enabled: n,
              ...
              if (
                ...
                for (a = i.content.split(","), e = 0, n = a.length; n > e; e++)
                  if (
                    ...
                    (t = s.split("=")),
                    2 === t.length &&
                      "initial-scale" === t[0].trim() &&
                      ((u = parseFloat(t[1])), u !== 0 / 0))
                  ) {
                    r = u;
                    break;
                  }
              return (
                o &&
                  ((r =
                    ...
                    window.innerWidth),
                  r > window.devicePixelRatio && (r = window.devicePixelRatio)),
                1 === r &&
                  window._vds_hybrid_config.phoneWidth &&
                  window.innerWidth !== window._vds_hybrid_config.phoneWidth &&
                  (r =
                    window._vds_hybrid_config.phoneWidth / window.innerWidth),
                r
              );
            },
          });
    ...
    23: [
      ...
      { "../../core/info/dom_info": 8, "./gr_user_info": 24 },
    ],
    24: [
      function (t, e, r) {
        var n,
        ...
        (n = t("../../core/info/gr_user_info")),
          (i = (function (t) {
            ...
            return (
              o(e, t),
              (e.prototype.isHybrid = !0),
              (e.prototype.cookieDomain = function () {
                return window._vds_hybrid_native_info
                  ? window._vds_hybrid_native_info.d
                  : "";
              }),
              (e.prototype.vid = function () {
                return window._vds_hybrid_native_info
                  ? window._vds_hybrid_native_info.u
                  : "";
              }),
              (e.prototype.hasSid = function () {
                return window._vds_hybrid_native_info &&
                  window._vds_hybrid_native_info.s
                  ? !0
                  : !1;
              }),
              ...
              (e.prototype.getCs1 = function () {
                return window._vds_hybrid_native_info
                  ? window._vds_hybrid_native_info.cs1
                  : "";
              }),
    ...
    25: [
      function (t, e, r) {
        ...
        (i = t("./observer/dom_observer")),
          (s = t("./sender")),
          (u = t("./hybrid_mode_detector")),
          (n = t("../core/base_launcher")),
          (d = t("./info/dom_info")),
          (a = t("./vendor/tree-mirror")),
          (o = (function (t) {
            function e() {
              (this.defaultSamplingFunc = h(this.defaultSamplingFunc, this)),
                (this.user = d.user()),
                ...
                (this.observer = new i(this.sender, this.user, this, a));
            }
            return (
              c(e, t),
              (e.prototype.afterInitialize = function () {
                return (
                  (window.vds.hybridVersion = "2.1.27"),
                  window._vds_hybrid
                    ? void 0
                    : (window._vds_hybrid = {
                        scale: u.calcScale(),
                        ...
                        startTracing: function (t) {
                          return (
                            (u.enabled = !0),
                            (u.isiOS = !0),
                            (u.withUIWebView = "UIWebView" === t),
                            (u.withWKWebView = !u.withUIWebView)
                          );
                        },
                        ...
                        pollEvents: (function (t) {
                          return function () {
                            var e;
                            return (e = t.sender).pollEvents.apply(
                              e,
                              arguments
                            );
                          };
                        ...
                        impressAllElements: (function (t) {
                          return function () {
                            return (
                              t.observer.trackPageView(),
                              null != t.observer.client
                                ? t.observer.client.impressElement(
                                    document.body
                                  )
                                : void 0
                            );
                        ...
                        snapshotAllElements: (function (t) {
                          return function () {
                            ...
                            try {
                              return (
                                (t.observer.client.snapshoting = !0),
                                null != t.observer.client &&
                                  t.observer.client.impressElement(
                                    document.body
                                  ),
                                (t.observer.client.snapshoting = !1)
                              );
                            } catch (r) {
                              e = r;
                            }
              ...
              (e.prototype.hybridSetUserId = function (t) {
                ...
                if (t && !(t.length > 1e3))
                  return (
                    window._vds_hybrid_native_info &&
                      (window._vds_hybrid_native_info.cs1 = t),
                    window._vds_bridge && window._vds_bridge.setUserId
                      ? window._vds_bridge.setUserId(t)
                      : window._vds_ios
                      ? ((e = { t: "hybridSetUserID", userID: t }),
                        (this.sender.nativeQueueReady = !0),
                        this.sender.sendQueue(e))
                      : void 0
                  );
              }),
              (e.prototype.hybridClearUserId = function () {
                ...
                return (
                  window._vds_hybrid_native_info &&
                    delete window._vds_hybrid_native_info.cs1,
                  window._vds_bridge && window._vds_bridge.clearUserId
                    ? window._vds_bridge.clearUserId("null")
                    : window._vds_ios
                    ? ((t = { t: "hybridClearUserID" }),
                      (this.sender.nativeQueueReady = !0),
                      this.sender.sendQueue(t))
                    : void 0
                );
              }),
              (e.prototype.hybridSetVisitor = function (t) {
                var e;
                if (t)
                  return window._vds_bridge && window._vds_bridge.setVisitor
                    ? window._vds_bridge.setVisitor(JSON.stringify(t))
                    : window._vds_ios
                    ? ((e = { t: "hybridSetVisitor", visitorJson: t }),
                      (this.sender.nativeQueueReady = !0),
                      this.sender.sendQueue(e))
                    : void 0;
              }),
    ...
    26: [
      function (t, e, r) {
        var n,
          ...
          p,
          f = [].slice;
        if ((t("../core/vendor/shim"), (n = t("./launcher")), window.launcher))
          return void console.log("already inserted script");
        for (
          window.launcher = a = new n(),
            h = [],
            window.gio && window.gio.hybrid
              ? (h = window.gio.hybrid)
              : ((null != (c = window.gio) ? c.q : void 0) &&
                  (h = h.concat(window.gio.q)),
                window._vds && (h = h.concat(window._vds))),
            s = 0,
            u = h.length;
          u > s;
          s++
        )
          (d = h[s]), null != a && a.apply.apply(a, d);
        (o = function () {
          var t;
          return (
            (t = 1 <= arguments.length ? f.call(arguments, 0) : []),
            a.apply.apply(a, t)
          );
        }),
          (o.platform = "hybrid"),
          (o.push = function () {
            return arguments.length > 1
              ? a.apply.apply(a, arguments)
              : a.apply.apply(a, arguments[0]);
          }),
          (window.gioGlobalArray = window.gioGlobalArray || []),
          window.gioGlobalArray.push(o),
          (window.gio = function () {
            var t, e, r, n, i;
            for (n = window.gioGlobalArray, e = 0, r = n.length; r > e; e++)
              (t = n[e]),
                "init" === (i = arguments[0]) || "send" === i
                  ? ("init" === arguments[0] &&
                      1 === window.gioGlobalArray.length &&
                      (window.gio.web = h),
                    "web" === t.platform && t.apply(null, arguments))
                  : t.apply(null, arguments);
            return window.gio && window.gio.web
              ? window.gio.web.push(arguments)
              : void 0;
          }),
          (window.gio.hybrid = void 0),
          (null != (l = window._vds_hybrid_config) ? l.enableHT : void 0) &&
            o.push(["enableHT", !0]),
          (null != (p = window._vds_hybrid_config) ? p.disableImp : void 0) &&
            o.push(["setImp", !1]),
          (i = "fakeAccountID"),
          window._vds_hybrid_native_info &&
            window._vds_hybrid_native_info.ai &&
            (i = window._vds_hybrid_native_info.ai),
          o("init", i, { setTrackerScheme: "http" }),
          o("send");
      },
      { "../core/vendor/shim": 20, "./launcher": 25 },
    ],
    27: [
      function (t, e, r) {
        var n,
            ...
            return (
              ...
              (e.prototype.appendElemAttrs = function (t, e, r, n) {
                ...
                if (
                  ...
                  (t.ew = c.width),
                  (t.eh = c.height),
                  n.containerMessage.length > 0 && n.pnode)
                ) {
                  for (
                    s = n.pnode.getBoundingClientRect(),
                      d = n.containerMessage,
                      h = [],
                      a = 0,
                      u = d.length;
                    u > a;
    ...
    28: [
      function (t, e, r) {
        ...
        (i = t("./hybrid_mode_detector")),
          (o = t("../core/tools/utils")),
          (n = (function () {
            function t(t, e) {
              (this.user = t),
                (this.callback = e),
                (this.sendWithIframe = s(this.sendWithIframe, this)),
                (this.sendQueue = s(this.sendQueue, this)),
                (this._send = s(this._send, this)),
                (this.send = s(this.send, this)),
                (this.eventCounter = 0),
                (this.nativeQueueReady = !0),
            ...
            return (
              ...
              (t.prototype.pollEvents = function () {
                var t;
                return (null != (t = this.messageQueue) ? t.length : void 0)
                  ? (this.sendWithIframe(this.messageQueue),
                    (this.messageQueue = []))
                  : (this.nativeQueueReady = !0);
              }),
              (t.prototype.send = function (t, e) {
                var r, n, i, s;
                if (o.isArray(t)) {
                  for (s = [], r = 0, n = t.length; n > r; r++)
                    (i = t[r]), s.push(this._send(i, e));
                  return s;
                }
              ...
              (t.prototype._send = function (t, e) {
                ...
                if (
                  ((t = t),
                  (t.d = o.domain_for_send()),
                  window._vds_hybrid_native_info &&
                  window._vds_hybrid_native_info.cs1
                    ? (t.cs1 = window._vds_hybrid_native_info.cs1)
                    : delete t.cs1,
                  "snap" === t.t)
                )
                  for (
                    t.e = t.e.reverse(), a = t.e, n = 0, s = a.length;
                    s > n;
                    n++
                  )
                    (r = a[n]),
                      (r.nodeType = "hybrid"),
                      (r.ex *= _vds_hybrid.scale),
                      (r.ey *= _vds_hybrid.scale),
                      (r.ew *= _vds_hybrid.scale),
                      (r.eh *= _vds_hybrid.scale);
                if ((t.tl && (t.v = t.tl), i.isAndroid)) {
                  if ("snap" === t.t)
                    return window._vds_bridge.hoverNodes(JSON.stringify(t));
                  if ("vst" !== t.t)
                    return "cstm" === t.t && window._vds_bridge.saveCustomEvent
                      ? window._vds_bridge.saveCustomEvent(JSON.stringify(t))
                      : window._vds_bridge.saveEvent(JSON.stringify(t));
                } else if (i.isiOS) return this.sendQueue(t);
              }),
              (t.prototype.sendQueue = function (t) {
                return i.withUIWebView
                  ? this.nativeQueueReady
                    ? this.sendWithIframe([t])
                    : this.messageQueue.push(t)
                  : i.withWKWebView
                  ? window.webkit.messageHandlers.GrowingIO_WKWebView.postMessage(
                      [t]
                    )
                  : void 0;
              }),
              (t.prototype.sendWithIframe = function (t) {
                var e;
                return (
                  (this.nativeQueueReady = !1),
                  (e =
                    "https://api.growingio.com/growinghybridsdk-" +
                    this.eventCounter++ +
                    "?" +
                    encodeURIComponent(JSON.stringify(t))),
                  this.dataIframe
                    ? (this.dataIframe.src = e)
                    : ((this.dataIframe = document.createElement("iframe")),
                      (this.dataIframe.style.display = "none"),
                      (this.dataIframe.style.position = "fixed"),
                      (this.dataIframe.style.width = 0),
                      (this.dataIframe.style.height = 0),
                      (this.dataIframe.style.border = "none"),
                      (this.dataIframe.src = e),
                      document.body.appendChild(this.dataIframe))
                );
              }),
              t
            );
      ...
      { "../core/tools/utils": 16, "./hybrid_mode_detector": 22 },
    ],
    29: [
      function (t, e, r) {
        (TreeMirrorClient = t("../../core/vendor/tree-mirror")),
          (TreeMirrorClient.Client.prototype.impressElement = function (t) {
