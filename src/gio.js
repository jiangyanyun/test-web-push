!(function t(e, r, n) {
...
})(
  {
            ...
            (w.prototype = {
              set: function (t, e) {
                ...
                return (
                  r && r[0] === t
                    ? (r[1] = e)
                    : b(t, this.name, { value: [t, e], writable: !0 }),
                  this
                );
              },
              get: function (t) {
          ...
          (i = (function () {
            function t() {
              (this.callback = h(this.callback, this)),
                (this.setGioIdByTouchSuccessCallback = h(
                  this.setGioIdByTouchSuccessCallback,
                  this
                )),
                (this.setGioIdByTouch = h(this.setGioIdByTouch, this)),
                (this.addRealTimeMessageCallBack = h(
                  this.addRealTimeMessageCallBack,
                  this
                )),
            ...
            var e;
            return (
              (t.prototype.version = "2.1.34"),
              (t.prototype.circleHost =
              ...
              (t.prototype.setTrackerScheme = function (t) {
                ...
                return t &&
                  d.isString(t) &&
                  ("http" === (e = t.toLocaleLowerCase()) || "https" === e)
                  ? (this.options.scheme = t + "://")
                  : void 0;
              }),
              ...
              (t.prototype.initialCSFields = function (t) {
                var e, r, n;
                for (n = [], e = r = 20; r >= 2; e = --r)
                  n.push(
                    (this["setCS" + e] = (function (t) {
                      return function (e) {
                        return function (e, r) {
                          var n;
              ...
              (t.prototype.initialPSFields = function () {
                var t, e, r;
                for (r = [], t = e = 20; e >= 1; t = --e)
                  r.push(
                    (this["setPS" + t] = (function (t) {
                      return function (e) {
                        return function (r) {
              ...
              (t.prototype.config = function (t) {
                ...
                for (r in t)
                  (i = t[r]),
                    r in e && (r = e[r]),
                    "object" == typeof i
                      ? this.apply.apply(this, [r].concat(l.call(i)))
                      : this.apply(r, i);
                n = [];
              ...
              (t.prototype.trackPV = function (t, e) {
                ...
                return (
                  t &&
                    ...
                    r.pageService.replaceProps(t),
                  null != (n = this.observer)
                    ? n.pageService.sendPV(null, e)
                    : void 0
                );
              }),
              ...
              (t.prototype.init = function (t, e, r) {
                ...
                if (t && d.isString(t) && 0 !== t.trim().length) {
                  for (
                    d.isString(t) && this.setAccountId(t),
                      d.isString(e) && null !== e.trim()
                        ? this.setAppId(e)
                        : d.isObject(e) && (r = e),
                      window.vds = {
                    ...
                    (s = o[n]), (this[s] = this.initDimensions(s));
              ...
              (t.prototype.setGioIdByTouch = function () {
                var t;
                return !(null != (t = this.user)
                  ? t.cookie.getItem("grwng_uid")
                  : void 0) &&
                  this.options.scheme &&
                  this.options.host
                  ? d.sendRequest(
                      this.options.scheme + this.options.host + "/touch",
                      this.setGioIdByTouchSuccessCallback
                    )
                  : void 0;
              }),
              (t.prototype.setGioIdByTouchSuccessCallback = function (t) {
                var e, r;
                return 200 === t.status && null != t.response
                  ? ((r = JSON.parse(t.response)),
                    r.grwng_uid && this.user.setGioId(r.grwng_uid),
                    null != (e = this.observer)
                      ? e.pageService.sendPV({ gioId: !0, useNewTime: !1 })
                      : void 0)
                  : void 0;
              }),
                ...
                if (!this.started)
                  try {
                    ...
                    for (
                      ...
                      (t = i[r]), this.apply.apply(this, t);
                  }
              }),
              (t.prototype.initSystemConfig = function (t) {
                var e, r, n, i;
                for (i = [], r = 0, n = t.length; n > r; r++)
                  (e = t[r]), i.push(this.apply.apply(this, e));
                return i;
              }),
              ...
              (t.prototype.connect = function () {
                ...
                return (
                  this.beforeConnect(),
                  this.setGioIdByTouch(),
                  this.sender.connect({ isBot: !!this.options.isBot })
                );
              }),
          ...
          (n = (function (t) {
            ...
            return (
              ...
              (e.prototype.set = function (t) {
                ...
                if (
                  2 === arguments.length &&
                  this.utils.isString(arguments[0]) &&
                  0 !== arguments[0].trim().length
                )
                  (e = {}), (e[arguments[0]] = arguments[1]), (t = e);
                else if (
                  1 !== arguments.length ||
                  !this.utils.isObject(arguments[0]) ||
                  this.utils.isEmptyObject(arguments[0])
                )
                  return;
                this.app_cache = this.app_cache ? this.app_cache : t;
                for (r in t) null != (n = this.app_cache) && (n[r] = t[r]);
                return (
                  this.lastSetTimeout && clearTimeout(this.lastSetTimeout),
    ...
    5: [
            ...
            return (
              ...
              (e.prototype.set = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["evar.set"].concat(c.call(arguments))
                  );
                if (
                  1 === arguments.length &&
                  this.utils.isObject(arguments[0]) &&
                  ...
                  if (
                    2 !== arguments.length ||
                    !this.utils.isString(arguments[0]) ||
                    !this.utils.isString(arguments[1]) ||
                    0 === !arguments[0].trim().length
                  )
                    return;
                  (e = {}), (e[arguments[0]] = arguments[1]), (t = e);
      ...
      { "../tools/utils": 18, "./base_dimension": 4 },
    ],
    6: [
      function (t, e, r) {
        var n,
          ...
          (i = (function (t) {
            ...
            return (
              ...
              (e.prototype.set = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["page.set"].concat(c.call(arguments))
                  );
                if (
                  1 === arguments.length &&
                  this.utils.isObject(arguments[0]) &&
              ...
              (e.prototype.sendPvar = function () {
                return this.utils.isEmptyObject(this.properties)
                  ? void 0
                  : (this.lastSetTimeout = setTimeout(
                      (function (t) {
                        return function () {
                          var e;
                          return (
                            (e = t._buildMessage(t.properties)),
                            t.send([e], "pvar")
                          );
                        };
                      })(this),
              ...
              (e.prototype.setName = function (t) {
                return (
                  (this.name = t),
                  this.name &&
                  this.utils.isString(this.name) &&
                  0 !== this.name.trim().length
                    ? this.observer.setPageGroup(this.name)
                    : void 0
                );
              }),
              (e.prototype.setPS = function (t, e) {
                ...
                if (this.name && this.utils.isString(t) && 0 !== t.length)
                  return this.pageService.reduceProps(
                    ((r = {}), (r["" + t] = e), r)
                  );
              }),
          ...
          (i = (function (t) {
            ...
            return (
              ...
              (e.prototype.set = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["people.set"].concat(c.call(arguments))
                  );
                if (
                  arguments.length > 1 &&
                  this.utils.isString(arguments[0]) &&
                  ...
                  (e = {}), (e[arguments[0].trim()] = arguments[1]), (t = e);
                else if (
                  !this.utils.isObject(arguments[0]) ||
                  this.utils.isEmptyObject(arguments[0])
                )
                  return;
                return this.gruser.isHybrid || this.getId()
                  ? (delete this.people_cache,
                    (r = this._buildPeopleMessage(t)),
                    this.send([r], "ppl"))
                  : void (this.people_cache = t);
              }),
              ...
              (e.prototype.setId = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["people.setId"].concat(c.call(arguments))
                  );
                if (t && window.vds.accountId && this.getId() !== t)
                  return (
                    this.people_cache && this.set(this.people_cache),
                    ...
                    this.getId() &&
                      this.getId() !== t &&
                      ((r = this.gruser.guid()), (a = !1)),
                    r === i &&
                      o === r &&
                      this.gruser.last_sent_cs1() !== t &&
                      (r = this.gruser.guid()),
                    this.getId() || (a = !1),
                    ...
                    setTimeout(
                      (function (t) {
                        return function () {
                          return (
                            t.observer.pageService.sendPV(
                              { sendVisit: !s, addPreProps: e, useNewTime: a },
            ...
            return (
              ...
              (e.prototype.track = function (t) {
                ...
                if (t) {
                  if (!this.launcher.started)
                    return this.launcher.pushToStack(
                      ["track"].concat(c.call(arguments))
                    );
                  for (n = i = 0, o = arguments.length; o > i; n = ++i)
                    (e = arguments[n]),
                      this.utils.isFunction(e)
                        ? (r = e)
                        : this.utils.isObject(e)
                        ? (a = e)
                        : 0 === n
                        ? (t = e)
                        : (s = e);
                  return (
                    (u = this._buildTrackMessage(t, a, s)),
                    u && this.send([u], "cstm"),
                    r ? r() : void 0
                  );
                }
          ...
          (i = (function (t) {
            ...
            return (
              ...
              (e.prototype.set = function (t) {
                ...
                if (!this.launcher.started)
                  return this.launcher.pushToStack(
                    ["visitor.set"].concat(c.call(arguments))
                  );
                if (
                  arguments.length > 1 &&
                  this.utils.isString(arguments[0]) &&
    ...
    10: [
          ...
          (n = (function () {
            ...
            return (
              (t.prototype.path = function (t, e) {
                ...
                if (t.tagName) {
                  for (
                      ...
                      (r.hasIdx()
                        ...
                        : ((S = r.path()),
                          (-1 !== S.indexOf("/dl") ||
                            -1 !== S.indexOf("/tr") ||
                            -1 !== S.indexOf("/li")) &&
                            ((l = !0), (d = this.index(r.node))))),
                    (b = r.node.parentNode),
                    e &&
                      "" !== s &&
                      (-1 !== u.indexOf(a, r.node.tagName) ||
                        r.isContainer()) &&
                      (p
                        ? (n.obj = h)
                        : u.hasAttr(r.node.parentNode, "data-growing-info") &&
                          (n.obj = r.node.parentNode.getAttribute(
                            "data-growing-info"
                          )),
                      (n.x = c),
                      o.push(n)),
                    ...
                    (r = new i(b)), 1 === c && (_ = r.node);
                  for (y.reverse(), f = 0, v = o.length; v > f; f++)
                    (w = o[f]),
                      (w.x = y.slice(0, c - w.x).join("")),
                      l && (w.idx = d),
                      p && (w.obj = h);
                  return (
                    (I = { xpath: s, containerMessage: o, isIgnore: g }),
                    p && (I.obj = h),
                    l && (I.idx = d),
                    _ && (I.pnode = _),
                    I
              ...
              (t.prototype.index = function (t) {
                ...
                for (
                  s = t;
                  s && "BODY" !== s.tagName && -1 === u.indexOf(o, s.tagName);
                ...
                if (s)
                  for (
                    ...
                    if (((i = c[e]), i.tagName === s.tagName)) {
                      if (
                        (u.hasAttr(i, "data-growing-idx") &&
                          (r = parseInt(i.getAttribute("data-growing-idx"))),
                        i === s)
                      )
                        return r;
                      r += 1;
              ...
              (t.prototype.containerElemContent = function (t) {
                var e;
                if (
                  u.hasAttr(t, "data-growing-title") &&
                  t.getAttribute("data-growing-title").length > 0
                )
      ...
      { "../tools/utils": 18, "./tagging_node_info": 12 },
    ],
    11: [
      function (t, e, r) {
        var n, i, o, s;
      ...
      { "../tools/guid": 16, "../tools/utils": 18, "../vendor/cookie": 19 },
    ],
    12: [
      function (t, e, r) {
        var n, i, o, s;
          ...
          (n = (function () {
            function t(t) {
              ...
              (this.node = t),
                ...
                s.hasAttr(t, "id") &&
                  null === t.getAttribute("id").match(/^[0-9]/) &&
                  (this.id = t.getAttribute("id")),
                (this.isIgnore =
                  s.hasAttr(t, "growing-ignore") ||
                  s.hasAttr(t, "data-growing-ignore")),
                s.hasAttr(t, "href") &&
                  ((e = t.getAttribute("href")),
                  e &&
                    0 !== e.indexOf("javascript") &&
                    (this.href = s.normalizePath(e.slice(0, 320)))),
                s.hasAttr(t, "data-growing-info") &&
                  (this.grObj = t.getAttribute("data-growing-info")),
                s.hasAttr(t, "data-growing-idx") &&
                  (this.grIdx = parseInt(t.getAttribute("data-growing-idx"))),
                "input" === this.name &&
                s.hasAttr(t, "name") &&
                t.getAttribute("name")
                  ? (this.klass = [t.getAttribute("name")])
                  : ((r =
                      null != (n = s.getKlassName(t, o))
                        ? n.replace(i, "").trim()
                        : void 0),
                    (null != r ? r.length : void 0) > 0 &&
                      (this.klass = r.split(/\s+/).sort()));
            }
            return (
              (t.prototype.path = function () {
                ...
                if (
                  ...
                  for (i = this.klass, t = 0, r = i.length; r > t; t++)
                    (e = i[t]), (n += "." + e);
                return n;
              }),
    ...
    13: [
          ...
          (n = (function () {
            ...
            return (
              ...
              (t.prototype.sendPageCallback = function (t) {
                return (
                  (this.pageLoaded = t.pageLoaded),
                  (this.prevPageAttrs = d.assignObj({}, t.preProperties)),
                  (this.lastActionTime = +Date.now())
                );
              }),
              (t.prototype.setPageGroup = function (t) {
                return this.pageService.setPageGroup(
                  t,
                  (function (e) {
                    return function (r) {
                      var n;
                      return (
                        e.sendPageCallback(r),
                        null != (n = e.messagingObserver)
                          ? n.sendPageLoad({ pg: t })
                          : void 0
                      );
                    };
              ...
              (t.prototype.setDeferWithPage = function (t, e) {
                return e
                  ? this.pageService.setDeferSendWithPage(
                      t,
                      e,
                    ...
                    return t.length
                      ? t.map(function (t) {
                          ...
                          return t.intersectionRatio > 0
                            ? ((e = d.getManualImpInfo(t.target)),
                              r.sendManualImp(e),
                              r.intersectionObserver.unobserve(t.target))
                            : void 0;
                        })
                      : void 0;
                  })),
                    ...
                    return (
                      ...
                      "attributes" === n.type
                        ? t.map(function (t) {
                            ...
                            return (
                              (e = t.target),
                              e.dataset.gioImpTrack
                                ? r.intersectionObserver.observe(e)
                                : void 0
                            );
                          })
                        : ((e = n.addedNodes),
                          e.length > 0
                            ? Array.from(e).map(function (t) {
                                return t.dataset && t.dataset.gioImpTrack
                  ...
                  Array.from(e).map(function (t) {
                    ...
                    return (
                      ...
                      (t.setAttribute = function (t, r) {
                        var n;
                        return (
                          (n = this.getAttribute("data-gio-imp-track")),
              ...
              (t.prototype.registerDomObserver = function () {
                ...
                if (window.vds.imp)
                  return (
                    ...
                    (t = {
                      initialize: (function (t) {
                        return function (e) {
                          ...
                          for (
                            ...
                            (r = e[o]),
                              "use" !== r.tagName &&
                                (i = i.concat(t.getLeafNodes(r, e.length)));
                          return (
                            (a.e = i),
                      ...
                      applyChanged: (function (t) {
                        return function (e, r, i, o) {
                          ...
                          if (
                            r.length > 0 &&
                            !document.body.className.match(/\bvds-entrytext\b/)
                          ) {
                            for (
                              t.gruser.hasSid() ||
                                t.pageService.sendPV(
                                  {
                                    sendVisit: !1,
                                    addPreProps: !0,
                                    useNewTime: !1,
                              ...
                              (h = r[u]),
                                "use" !== h.tagName &&
                                  (a = a.concat(t.getLeafNodes(h, h.length)));
                            if (((d.e = a), a.length > 0))
                    ...
                    this.TreeMirror
                      ? (this.client = n = new this.TreeMirror.Client(
                          document.body,
                          t
                        ))
                      : void 0
              ...
              (t.prototype.idle = function () {
                return (
                  (this.lastSentTime = this.lastSentTime || +Date.now()),
                  this.lastSentTime &&
                    (+Date.now() - this.lastSentTime) / p.length > 300
                );
              }),
              ...
              (t.prototype.sendQueue = function () {
                return (
                  p.length > 0 &&
                    +Date.now() - this.lastActionTime < 12e4 &&
                    this.sender.send(p),
              ...
              (t.prototype.getLeafNodes = function (t, e) {
                ...
                if (((u = []), (f = !0), t.leaf))
                  1 === t.nodeType &&
                    ((null != (g = t.attributes) ? g.href : void 0) ||
                      null != t.text ||
                      null != t.obj) &&
                    ((p = this.nodeMessage(t, !0)),
                    e > 1 && (p.idx = t.idx),
                    u.push(p));
                else if (
                  (t.isContainer && ((p = this.nodeMessage(t, !0)), u.push(p)),
                  0 === t.childNodes.length && -1 === d.indexOf(_, t.tagName))
                );
                else {
                  for (v = t.childNodes, o = 0, c = v.length; c > o; o++)
                    (n = v[o]),
                      n.leaf || (f = !1),
                      "use" !== n.tagName &&
                        (u = u.concat(
                          this.getLeafNodes(n, t.childNodes.length)
                        ));
                  if (
                    ((-1 !== d.indexOf(w, t.tagName) ||
                      (f &&
                        ((null != (m = t.attributes) ? m.any : void 0) ||
                          t.text))) &&
                      (t.text ||
                        ((i = t.dom),
                        (t.text = i
                          ? this.info.containerElemContent(i)
                          : d.parentOfLeafText(t))),
                      (p = this.nodeMessage(t, !1)),
                      u.push(p)),
                    "SPAN" === t.tagName)
                  )
                    for (b = t.childNodes, s = 0, h = b.length; h > s; s++)
                      if (((n = b[s]), "svg" === n.tagName))
                        for (y = n.childNodes, a = 0, l = y.length; l > a; a++)
                          (r = y[a]),
                            1 === r.nodeType &&
                              "use" === r.tagName &&
                              d.hasAttr(r, "xlink:href") &&
                              ((t.text = r.getAttribute("xlink:href")),
                              (p = this.nodeMessage(t, !1)),
                              u.push(p));
                }
                return u;
              ...
              (t.prototype.nodeMessage = function (t, e) {
                ...
                return (
                  ...
                  "A" === t.tagName &&
                    0 === (null != (o = t.text) ? o.length : void 0) &&
                    (i.v = void 0),
                  (null != (s = t.text) ? s.length : void 0) > 50 &&
                    (i.v =
                      "A" === t.tagName
                        ? d.processText(t.text.slice(0, 50))
                        : void 0),
                  (r = t.attributes) &&
                    r.href &&
                    0 !== r.href.indexOf("javascript") &&
                    ((i.h = d.normalizePath(r.href.slice(0, 320))),
              ...
              (t.prototype.registerEventListener = function () {
                ...
                (a = {
                  ...
                  (h = function (t) {
                    return t.which > 1 || ((S = +Date.now()), f === S)
                      ? void 0
                      : ((f = S),
                        (g = {
                          time: S,
                        ...
                        (O = setTimeout(function () {
                          return (
                            (t = { target: g.target, type: "click" }), s(t)
                          );
                        }, 100)));
                  }),
                  (c = function (t) {
                  ...
                  (u = function (t, e) {
                    var n;
                    return (
                      (n = r ? e.touches[0] : e), n["page" + t.toUpperCase()]
                    );
                  }),
                  (i = function () {
                    ...
                    for (e = 0, u = v.length; u > e; e++)
                      (t = v[e]), n(document, t, h);
                    for (s = 0, d = f.length; d > s; s++)
                      (t = f[s]), n(document, t, c);
                    for (g = [], a = 0, p = m.length; p > a; a++)
                      (t = m[a]), g.push(n(document, t, l));
                    return g;
                  }),
                  (s = (function (t) {
                    return function (r) {
                      ...
                      if (!document.body.className.match(/\bvds-entrytext\b/)) {
                        ...
                        for (
                          t.lastActionTime = +Date.now(),
                            h = r.target || r.srcElement;
                          h && 1 === C[h.tagName] && h.parentNode;

                        )
                          h = h.parentNode;
                        if (((n = t.info.path(h, !0)), n.isIgnore)) return;
                        if (
                          (window.vds.impCtrlDua &&
                            (window.grImpCtrl = Date.now()),
                          (c = h.tagName),
                          "click" === r.type)
                        ) {
                          if (-1 !== d.indexOf(e, c)) return;
                          if ("INPUT" === c && -1 === d.indexOf(y, h.type))
                            return;
                          if (
                            -1 === d.indexOf(_, c) &&
                            !t.info.depthInside(h, 4)
                          )
                            return;
                        }
                        return (
                          t.gruser.hasSid()
                            ? "click" === r.type &&
                              t.pageService.sendPVOnSidChanged(
                                t.sendPageCallback
                              )
                            : t.pageService.sendPV(
                                {
                          ...
                          n.idx
                            ...
                            : (-1 !== o.x.indexOf("/dl") ||
                                -1 !== o.x.indexOf("/tr") ||
                                -1 !== o.x.indexOf("/li")) &&
                              (o.idx = t.info.index(h)),
                          (s.e =
                            0 === n.containerMessage.length
                              ? [o]
                              : -1 !== d.indexOf(w, n.pnode.tagName) &&
                                t.info.onlyContainsChildren(n.pnode, m)
                              ? n.containerMessage
                              : [o].concat(n.containerMessage)),
                          u ? t.snapshotCallback(r, s) : t.sender.send([s])
                        );
                      }
                    };
                  })(this));
                for (o in a) n(document, o, s);
                return (
                  n(document, "scroll", function (t) {
                    return window.vds.impCtrlDua
                      ? (window.grImpCtrl = Date.now())
                      : void 0;
                  }),
              ...
              (t.prototype.compute = function (t, e) {
                var r, n, i, o, s, a, u, c, h, l, p, f, g, m, b, _, I, S, O, C;
                if (
                  ((n = {}),
                  (O = e.tagName),
                  "IMG" === O
                    ? (null != (_ = e.src) ? _.length : void 0) > 0 &&
                      -1 === e.src.indexOf("data:image") &&
                      (n.h = e.src)
                    : d.hasAttr(e, "href") &&
                      ((i = e.getAttribute("href")),
                      i &&
                        0 !== i.indexOf("javascript") &&
                        (n.h = d.normalizePath(i.slice(0, 320)))),
                  d.hasAttr(e, "data-growing-title") &&
                    e.getAttribute("data-growing-title").length > 0)
                )
                  n.v = e.getAttribute("data-growing-title");
                else if (
                  d.hasAttr(e, "title") &&
                  e.getAttribute("title").length > 0
                )
                  ...
                  if (this.info.isLeaf(e))
                    ...
                    else if ("INPUT" === O && -1 !== d.indexOf(y, e.type))
                      n.v = d.processText(e.value);
                    else if ("svg" === O)
                      for (I = e.childNodes, o = 0, m = I.length; m > o; o++)
                        (r = I[o]),
                          1 === r.nodeType &&
                            "use" === r.tagName &&
                            d.hasAttr(r, "xlink:href") &&
                            (n.v = r.getAttribute("xlink:href"));
                    else
                      (C = ""),
                        null != e.textContent
                          ? (C = e.textContent.replace(/[\n \t]+/g, " ").trim())
                          : null != e.innerText &&
                            (C = e.innerText.replace(/[\n \t]+/g, " ").trim()),
                        C.length > 0 &&
                          (C.length < 50
                            ? (n.v = d.processText(C))
                            : "A" === O &&
                              (n.v = d.processText(C.slice(0, 50))));
                  else
                    -1 !== d.indexOf(w, O)
                      ? (n.v = this.info.containerElemContent(e))
                      : this.info.isParentOfLeaf(e) &&
                        (n.v = d.parentOfLeafText(e));
                else if ("change" === t)
                  "TEXTAREA" !== O &&
                    ("INPUT" === O
                      ? -1 !== d.indexOf(v, e.type)
                        ? ((n.v = d.processText(e.value)),
                          (h = e.parentNode),
                          "LABEL" === h.tagName
                            ? (c = h)
                            : "BODY" !== h.tagName &&
                              ...
                              "LABEL" === h.tagName
                                ? (c = h)
                                : e.id &&
                                  ((g = h.getElementsByTagName("label")),
                                  (function () {
                                    var t, r, n;
                                    for (
                                      n = [], t = 0, r = g.length;
                                      ...
                                      (f = g[t]), n.push(f["for"] === e.id);
                                    return n;
                                  })() && (c = f))),
                          null != c &&
                            ((l = this.info.containerElemContent(c)),
                            (null != l ? l.length : void 0) > 0 &&
                              (n.obj = l + " (" + e.checked + ")")))
                        : "password" !== e.type &&
                          (d.hasAttr(e, "growing-track") ||
                            d.hasAttr(e, "data-growing-track")) &&
                          (n.v = d.processText(e.value))
                      : "SELECT" === O &&
                        ((n.v = d.processText(e.value)),
                        1 === e.selectedOptions.length &&
                          null != e.selectedOptions[0].label &&
                          (n.obj = e.selectedOptions[0].label)));
                else if ("submit" === t)
                  for (
                    S = e.getElementsByTagName("input"), p = 0, b = S.length;
                    b > p;
                    p++
                  )
                    (u = S[p]),
                      ("search" === u.type ||
                        ("text" === u.type &&
                          ("q" === u.id ||
                            -1 !== u.id.indexOf("search") ||
                            -1 !== u.className.indexOf("search") ||
                            "q" === u.name ||
                            -1 !== u.name.indexOf("search")))) &&
                        ((n.x = this.info.path(u).xpath),
                ...
                return (
                  ...
                  null != t &&
                    (window.history.pushState = (function (e) {
                      return function () {
                        return (
                          (e.prevUrl = window.location.toString()),
                  ...
                  null != e &&
                    (window.history.replaceState = (function (t) {
                      return function () {
                        return (
                          (t.prevUrl = window.location.toString()),
                  ...
                  null != t &&
                    ((this.prevUrl = d.getDocumentReferrer()),
                  ...
                  window.vds.hashtag
                    ? d.bind(window, "hashchange", this.pageChanged, !0)
                    : void 0
                );
              }),
              (t.prototype.pageChanged = function () {
                ...
                return (
                  (t = d.path()),
                  (e = d.query()),
                  this.currentPath !== t || this.currentQuery !== e
                    ? (window.vds.hashtag &&
                        ((this.prevUrl =
                        ...
                        this.currentQuery &&
                          ...
                          (this.prevUrl += "?" + this.currentQuery)),
                      (this.currentPath = t),
                      (this.currentQuery = e),
                      this.pageService.sendPV(
                        { sendVisit: !0, useNewTime: !0 },
                        this.sendPageCallback
                      ),
                      null != (r = this.messagingObserver)
                        ? r.sendPageLoad(this.prevPageAttrs)
                        : void 0)
                    : void 0
                );
              }),
                ...
                if (!this.domLoadedHandler.done) {
                  if (
                    ...
                    try {
                      d.detectIE() &&
                      null !=
                        (null != (e = window.angular) ? e.version : void 0)
                        ? (window.angular.version.major > 1 ||
                            (1 === window.angular.version.major &&
                              window.angular.version.minor > 4) ||
                            (1 === window.angular.version.major &&
                              4 === window.angular.version.minor &&
                              window.angular.version.dot > 0)) &&
                          (vds.imp &&
                            setTimeout(
                              (function (t) {
                                return function () {
                  ...
                  return (
                    window.history.pushState && this.registerHistoryHandler(),
                    ...
                    return function (e) {
                      ...
                      try {
                        switch (
                          ...
                          "update-global-env" === i &&
                            (window.grCircleEnv = r.add_on_grSource),
                          i)
                        ) {
                          case "gr-register-SDK-circle":
                            return (
                              t.registerCircleHandler(),
                              d.spreadToInnerIframes(r)
                            );
                          case "gr-register-SDK-option":
                            if (
                              t.canPostRegisterMessage() &&
                              "grcw" === window.grSource.name &&
                              ((o = window.grSource.id), l.call(r.tArr, o) < 0)
                            )
                              return (
                                r.tArr.push(window.grSource.id),
              ...
              (t.prototype.loadPluginOuter = function (t) {
                ...
                for (
                  ...
                  if (
                    ...
                    null != u && -1 !== u.indexOf("/outer-circle-plugin.js"))
                  ) {
                    this.pluginLoaded = !0;
                    break;
                  }
                return this.pluginLoaded
                  ? void 0
                  : ((s = t.add_on_grSource.add_on_origin),
                    ...
                    (e.src =
                      -1 === s.indexOf("http")
                        ? "//" +
                          s +
                          "/assets/javascripts/outer-circle-plugin.js"
                        : s + "/assets/javascripts/outer-circle-plugin.js"),
                    ...
                    (r.href =
                      -1 === s.indexOf("http")
                        ? "//" +
                          s +
                          "/assets/stylesheets/outer-circle-plugin.css"
                        : s + "/assets/stylesheets/outer-circle-plugin.css"),
              ...
              (t.prototype.canPostRegisterMessage = function () {
                return "grcw-outer-iframe" === window.grSource.name
                  ? !1
                  : d.isSpreadPostMessage()
                  ? !0
                  : vds.circleIframe
                  ? parent &&
              ...
              (t.prototype.setPSForActionMessage = function (t) {
                return this.prevPageAttrs.pg
                  ? (t.pg = this.prevPageAttrs.pg)
                  : void 0;
              }),
      ...
      },
      {
        "../page_service": 15,
        "../tools/utils": 18,
        "../vendor/intersection-observer": 20,
        "../vendor/mutation-observer": 23,
          ...
          (n = (function () {
            ...
            return (
                ...
                return s.bind(
                  ...
                  (function (t) {
                    return function (e) {
                      ...
                      if (
                        ((r = e.data),
                        r.ai === window.vds.accountId &&
                          ((n = r.mode || r.circleMode),
                          t.isSdkEvent(n) && (!r.fsna || "sdk" === r.fsna)))
                      ) {
                        if (
                          "grcw-inner-iframe" === r.sna &&
                          s.isSpreadPostMessage()
                        )
                          return void parent.postMessage(e.data, "*");
                        if (((i = r.mode), u.call(o, i) >= 0))
                          s.spreadToInnerIframes(r);
                        else if (
                          r.tna !== window.grSource.name &&
                          r.tna &&
                          r.tid &&
                          s.isSpreadPostMessage()
                        )
                        ...
                        if (
                          ...
                          u.call(o, a) >= 0 ||
                            r.tna === window.grSource.name ||
                            e.origin === window.vds.origin ||
                            -1 !==
                              s.indexOf(
                                ["www.growingio.com", "growingio.com"],
                                e.origin.split("://")[1]
                              ))
                        )
                          switch (
                            (e.origin !== window.vds.origin &&
                              (window.vds.origin = e.origin),
                            r.mode)
                          ) {
                            case "load-plugin":
              ...
              (t.prototype.sendPageLoad = function (t) {
                var e, r, n, i, o;
                null == t && (t = null),
                  (i = (null != (n = window.vds) ? n.pathCaseSensitive : void 0)
                    ? window.location.toString()
                    : window.location.toString().toLowerCase());
                for (e in vds)
                  (o = vds[e]),
                    "function" == typeof o &&
                      (vds[e] = s.functionSerialization(o));
                return (
                  (r = {
              ...
              (t.prototype.loadPluginInner = function () {
                ...
                for (
                  this.pluginLoaded = !1,
                    t = s.getCirclePluginFileName(
                      window._gr_support_circle_pop_out
                    ),
                    a = document.getElementsByTagName("script"),
                    i = 0,
                    o = a.length;
                ...
                return this.pluginLoaded ||
                  ...
                  (e.charset = "UTF-8"),
                  (e.src =
                    -1 === this.allowOrigin.indexOf("http")
                      ? "//" +
                        this.allowOrigin +
                        "/assets/javascripts/" +
                        t +
                        ".js"
                      : this.allowOrigin + "/assets/javascripts/" + t + ".js"),
                  document.head.appendChild(e),
                  ...
                  : ((r = document.createElement("link")),
                    ...
                    (r.href =
                      -1 === this.allowOrigin.indexOf("http")
                        ? "//" +
                          this.allowOrigin +
                          "/assets/stylesheets/circle-plugin.css"
                        : this.allowOrigin +
                          "/assets/stylesheets/circle-plugin.css"),
                    document.head.appendChild(r));
              }),
              ...
              (t.prototype.stopCircle = function () {
                return "undefined" != typeof CircleEvents &&
                  null !== CircleEvents
                  ? CircleEvents.publish("circle:stop")
                  : void 0;
              }),
              (t.prototype.publishCircle = function () {
                return "undefined" != typeof CircleEvents &&
                  null !== CircleEvents
                  ? (this.registerInnerIframe(),
                    CircleEvents.publish("circle:start"))
                  : setTimeout(
                      (function (t) {
                        return function () {
      ...
      function (t, e, r) {
        ...
        (i = t("./tools/utils")),
          (n = (function () {
            ...
            return (
              (t.prototype.replaceProps = function (t) {
              ...
              (t.prototype.sendPV = function (t, e) {
                ...
                if (
                  ...
                  null != this.sender.sendVisitTimeout &&
                    this.sender.sendVisitTimeout > 0)
                )
                ...
                if (this.options.addPreProps || this.options.gioId)
                  for (n in this.preProperties)
                    null == (r = this.properties)[n] &&
                      (r[n] = this.preProperties[n]);
                return (
                  (this.options.gioId ||
                    (this.options.sendVisit && this.gruser.isSendNewVisit())) &&
                    this.messages.push(this._buildVisitMessage()),
                  this.options.useNewTime && (this.pageLoaded = +Date.now()),
                  null == this.pageLoaded && (this.pageLoaded = +Date.now()),
                  this.options.gioId ||
                    this.messages.push(this._buildPageMessage()),
              ...
              (t.prototype.setPageGroup = function (t, e) {
                return t
                  ? (this.reduceProps({ pg: t }),
                    this.pageLoaded &&
                    +Date.now() - this.pageLoaded < 4e3 &&
              ...
              (t.prototype.setDeferSendWithPage = function (t, e, r) {
                return e || t
                  ? (this.reduceProps(t),
                    e(this)
                      ? this.sendPV({ addPreProps: !0, useNewTime: !1 }, r)
                      : void 0)
                  : void 0;
              }),
              (t.prototype._buildPageMessage = function () {
                ...
                if (
                  ((r = {
                    ...
                    t: "page",
                    tm: this.pageLoaded,
                    pt: window.location.protocol.substring(
                      0,
              ...
              (t.prototype._buildVisitMessage = function () {
                ...
                return (
                  (e = {
                    ...
                    l:
                      null !=
                      (r = navigator.language || navigator.browserLanguage)
                        ? r.toLowerCase()
                        : void 0,
                  }),
                  i.query().length > 0 && (e.q = i.query()),
                  (t = this.gruser.getCs1()),
                  t && (e.cs1 = t),
              ...
              (t.prototype.sendPVOnSidChanged = function (t) {
                var e, r, n;
                return (
                  (e = this.gruser.currentSessionId()),
                  (n = e[0]),
                  (r = e[1]),
                  this.gruser.lastSessionId !== n
                    ? (n ||
                        ((n = this.gruser.guid()), this.gruser.resetUserId()),
                      this.gruser.updateSessionId(n, !1),
                      this.sendPV({ sendVisit: !0, useNewTime: !0 }, t))
                    : void 0
                );
              }),
              t
          ...
          (n = (function () {
            ...
            return (
              (t.get = function (t) {
                ...
                try {
                  return window.localStorage
                    ? this._readFromLocalStorage(t)
                    : this._readFromCookie(t);
                } catch (r) {
                  return (e = r), null;
                }
              }),
              (t.set = function (t, e, r) {
                ...
                try {
                  return window.localStorage
                    ? this._setInLocalStorage(t, e, r)
                    : this._setInCookie(t, e, r / 1e3);
                } catch (i) {
                  return (n = i), null;
                }
              }),
              ...
              (t._setInLocalStorage = function (t, e, r) {
                return window.localStorage.setItem(
                  t,
                  JSON.stringify({ expiredAt: +Date.now() + r, value: e })
                );
              }),
              ...
              (t.removeItem = function (t) {
                ...
                try {
                  return (
                    window.localStorage && this.removeInLocalStorage(t),
    ...
    18: [
        ...
        (o = t("./guid")),
          ...
          (s = {
            ...
            path: function () {
              var t, e, r;
              return (
                (e = this.normalizePath(window.location.pathname)),
                window.vds.hashtag &&
                  ((t = window.location.hash),
                  (e += -1 !== t.indexOf("?") ? t.split("?")[0] : t)),
                (null != (r = window.vds) ? r.pathCaseSensitive : void 0)
                  ? e
                  : e.toLowerCase()
              );
            },
              ...
              return (
                ...
                (e && "grcw" === e) ||
                  (window.top === window.self
                    ? (e = "grcw-outer-iframe")
                    : (this.printWarning(
                        "检测到疑似window复写或者嵌套iframe。 window.name值: " +
                          e
                      ),
                      (e = "grcw-inner-iframe"))),
                (window.grSource = { name: e, id: t })
              );
            },
            ...
            getWindowSourceName: function () {
              var t, e;
              return (
                (e = null != window.name ? window.name : window.self.name),
                e &&
                  window.nameStorage &&
                  ((t = e.split(/[:?]/)),
              ...
              return (
                ...
                (t =
                  t.length > 1 && "?" === t.charAt(0)
                    ...
                    : t),
                (null != (e = window.vds) ? e.pathCaseSensitive : void 0)
                  ? t
                  : t.toLowerCase()
              );
            },
                ...
                (e = a[i]),
                  3 === e.nodeType &&
                    (null != e.textContent
                      ...
                      : null != e.data && (r = e.data.trim()),
                    r.length > 0 && (n += r + " "));
              return (
                (n = n.replace(/[\n \t]+/g, " ").trim()),
                n.length > 0 && n.length < 50 ? s.processText(n) : void 0
              );
            },
            ...
            detectIE: function () {
              ...
              return (
                ...
                window.ActiveXObject && ((e = i.indexOf("MSIE ")), e > 0)
                  ? parseInt(i.substring(e + 5, i.indexOf(".", e)), 10)
                  : ((n = i.indexOf("Trident/")),
                    n > 0
                      ? ((r = i.indexOf("rv:")),
                        parseInt(i.substring(r + 3, i.indexOf(".", r)), 10))
                      : ((t = i.indexOf("Edge/")),
                        t > 0
                          ? parseInt(i.substring(t + 5, i.indexOf(".", t)), 10)
                          : !1))
              );
            },
            hashCode: function (t) {
              ...
              if (
                ...
                return r;
              for (n = 0; n < t.length; )
                (e = t.charCodeAt(n)), (r = (r << 5) - r + e), (r &= r), n++;
              return r;
            },
            ...
            spreadToInnerIframes: function (t) {
              ...
              for (
                ...
                (e = r[n]), o.push(this.spread(t, e));
              return o;
            },
            spread: function (t, e) {
              var r;
              return (
                (r = null != e ? e.contentWindow : void 0),
                ...
                for (r in t)
                  if (
                    ...
                    null != i &&
                      ...
                      (i = i.length <= 1e3 ? i : i.slice(0, 1e3)),
                    (n[e] = i),
            ...
            processText: function (t) {
              return null == window.vds.textEncryptFunc
                ? t
                : null != t
                ? window.vds.textEncryptFunc.call(this, t)
                : void 0;
            },
            getManualImpInfo: (function (t) {
              return function (t) {
                var e, r, n, i, o, s, a, u;
                if (
                  !t.hasAttribute("data-gio-imp-track") ||
                  !t.getAttribute("data-gio-imp-track")
                )
                  return null;
                o = t.getAttribute("data-gio-imp-track");
                try {
                  for (
                    i = {
                      n: o,
                    ...
                    (e = r[s]),
                      (u = e.name.match(/^data-gio-track-(.+)/)),
                      u &&
                        (i["var"] || (i["var"] = {}),
                        (i["var"][u[1]] = t.getAttribute(e.name)));
                  return i;
                } catch (c) {
                  return (n = c), console.warn("半自动imp打点格式不正确");
                }
              };
            })(this),
          }),
      ...
      { "../vendor/cookie": 19, "./guid": 16, "./local_store": 17 },
    ],
    19: [
      function (t, e, r) {
                  ...
                  if (
                    ...
                    if (Object.prototype.hasOwnProperty.call(a, d)) {
                      if (d.charCodeAt(0) < 256) {
                        ...
                        for (i = d.charCodeAt(0), n = 0; 8 > n; n++)
                          (g = (g << 1) | (1 & i)),
                            v == e - 1 ? ((v = 0), f.push(r(g)), (g = 0)) : v++,
                            (i >>= 1);
                      } else {
                        for (i = 1, n = 0; p > n; n++)
                          (g = (g << 1) | i),
                            v == e - 1 ? ((v = 0), f.push(r(g)), (g = 0)) : v++,
                            (i = 0);
                        for (i = d.charCodeAt(0), n = 0; 16 > n; n++)
                          (g = (g << 1) | (1 & i)),
                            v == e - 1 ? ((v = 0), f.push(r(g)), (g = 0)) : v++,
                            (i >>= 1);
                      }
        ...
        window.MutationObserver =
          ...
          (function (t) {
            ...
            function n(e) {
              ...
              for (var n in e) g(r, n) && e[n] !== t && (r[n] = e[n]);
              return r;
            }
            function i(t, e) {
              var r = c(t, e);
            ...
            function u(e, r, i, o) {
              function s(t, r, i, s, c) {
                for (
                  var d, h, l, p = t.length - 1, f = -~((p - c) / 2);
                  (l = t.pop());
              ...
              function u(r, i) {
                for (
                  ...
                  (w = y[C]),
                    ...
                    (b = m && m.node),
                    w === b
                      ? (o.attr && m.attr && a(e, w, m.attr, o.afilter),
                        o.charData &&
                          m.charData !== t &&
                          w.nodeValue !== m.charData &&
                          e.push(
                            n({
                              type: "characterData",
                              target: w,
                        ...
                        p && s(p, r, y, _, O),
                        o.descendents &&
                          (w.childNodes.length || (m.kids && m.kids.length)) &&
                          u(w, m),
                        C++,
                        N++)
                      : ((c = !0),
            ...
            function l(t, e) {
              for (var r = [], n = 0; n < t.length; n++) r[n] = e(t[n], n, t);
              return r;
            }
            function p(t, e, r) {
              for (var n = 0; n < t.length; n++) r = e(r, t[n], n, t);
              return r;
            }
            function f(t, e, r, n) {
              for (; r < t.length; r++)
                if ((n ? t[r][n] : t[r]) === e) return r;
              return -1;
            }
            function g(e, r) {
              return e[r] !== t;
                ...
                observe: function (t, e) {
                  for (
                    var n = {
                        ...
                        charData: !(
                          !e.characterData && !e.characterDataOldValue
                        ),
                      },
                      o = this._watched,
                      s = 0;
            ...
            (m.style.top = 0), (m = "null" != m.attributes.style.value);
            var w = m ? o : s,
              b = 1,
              y = "mo_id";
            return e;
    ...
    24: [
      function (t, e, r) {
        ...
        if (!u)
          throw (
            (console && console.error("DOM Mutation Observers are required."),
            console &&
              console.error(
        ...
        var h = (function () {
            ...
            return (
              (t.prototype.getAttributeOldValue = function (t) {
                return this.attributeOldValues
          ...
          p = (function (t) {
            ...
            return (
              ...
              (e.prototype.getWasReachable = function (t) {
                ...
                return (
                  void 0 === e &&
                    ((e = this.getWasReachable(this.getOldParent(t))),
            ...
            return (
              ...
              (t.prototype.visitNode = function (t, e) {
                if (!this.visited.has(t)) {
                  ...
                  var r = this.treeChanges.get(t),
                    n = e;
                  if (
                    (((r && r.childList) || void 0 == n) &&
                      (n = this.treeChanges.reachabilityChange(t)),
                    n !== c.STAYED_OUT)
                  ) {
                    if ((this.matchabilityChange(t), n === c.ENTERED))
                      this.entered.push(t);
                    else if (n === c.EXITED)
                      this.exited.push(t),
              ...
              (t.prototype.getChanged = function (t, e, r) {
                ...
                for (var s = this.stayedIn.keys(), n = 0; n < s.length; n++) {
                  var i = s[n],
                    o = this.matchabilityChange(i);
                  if (o === c.ENTERED) t.added.push(i);
                  else if (o === c.EXITED) t.removed.push(i);
                  else if (o === c.STAYED_IN && (t.reparented || t.reordered)) {
                    var a = this.stayedIn.get(i);
                    t.reparented && a === c.REPARENTED
                      ? t.reparented.push(i)
                      : t.reordered && a === c.REORDERED && t.reordered.push(i);
                  }
                }
              ...
              (t.prototype.attributeChangedNodes = function (t) {
                ...
                for (
                  var o = {}, s = this.treeChanges.keys(), n = 0;
                  n < s.length;
                  n++
                ) {
                  var a = s[n],
                  ...
                  if (
                    u.attributes &&
                    c.STAYED_IN === this.treeChanges.reachabilityChange(a) &&
                    c.STAYED_IN === this.matchabilityChange(a)
                  )
                    for (
                      var d = a, h = u.getAttributeNamesMutated(), l = 0;
                      l < h.length;
                      l++
                    ) {
                      var i = h[l];
              ...
              (t.prototype.getCharacterDataChanged = function () {
                ...
                for (
                  var t = this.treeChanges.keys(), e = [], r = 0;
                  r < t.length;
                  r++
                ) {
                  var n = t[r];
                  if (c.STAYED_IN === this.treeChanges.reachabilityChange(n)) {
                    ...
                    i.characterData &&
                      n.textContent != i.characterDataOldValue &&
                      e.push(n);
                  }
                }
                return e;
              ...
              (t.prototype.computeMatchabilityChange = function (t, e) {
                ...
                return (
                  void 0 === n &&
                    ((n = t.matchabilityChange(e, this.treeChanges.get(e))),
                    r.set(e, n)),
                  n
                );
              }),
              (t.prototype.matchabilityChange = function (t) {
                ...
                for (
                  var r = t,
                    n = this.selectors.map(function (t) {
                      return e.computeMatchabilityChange(t, r);
                    }),
                    i = c.STAYED_OUT,
                    o = 0;
                  i !== c.STAYED_IN && o < n.length;
              ...
              (t.prototype.getChildlistChange = function (t) {
                ...
                return (
                  e || ((e = new l()), this.childListChangeMap.set(t, e)), e
                );
              }),
              (t.prototype.processChildlistChanges = function () {
                function t(t, e) {
                  !t ||
                    ...
                    n.added.has(t) ||
                    n.maybeMoved.has(t) ||
                    (e && (n.added.has(e) || n.maybeMoved.has(e))) ||
                ...
                if (!this.childListChangeMap) {
                  ...
                  for (var e = 0; e < this.mutations.length; e++) {
                    ...
                    if (
                      "childList" == r.type &&
                      (this.treeChanges.reachabilityChange(r.target) ===
                        c.STAYED_IN ||
                        this.calcOldPreviousSibling)
                    ) {
                      for (
                        var n = this.getChildlistChange(r.target),
                          i = r.previousSibling,
                          o = 0;
                        ...
                        t(s, i),
                          n.added.has(s)
                            ? n.added.remove(s)
                            : (n.removed.set(s, !0), n.maybeMoved.remove(s)),
                          (i = s);
                      }
                      t(r.nextSibling, i);
                      for (var o = 0; o < r.addedNodes.length; o++) {
                        ...
                        n.removed.has(s)
                          ? (n.removed.remove(s), n.maybeMoved.set(s, !0))
                          : n.added.set(s, !0);
                      }
                    }
                  }
              ...
              (t.prototype.wasReordered = function (t) {
                ...
                function r(t) {
                  ...
                  for (
                    n = s.oldPrevious.get(t);
                    n && (s.removed.has(n) || e(n));

                  )
                    n = r(n);
                  return (
                    void 0 === n && (n = t.previousSibling), u.set(t, n), n
                  );
                }
                function n(t) {
          ...
          g = (function () {
            function t(t, e) {
              ...
              if (
                ...
                e.attribute
                  ? (this.valueChanged = i[e.attribute] || [])
                  : ((this.attributeChanged = i),
                    e.attributeList &&
                      e.attributeList.forEach(function (t) {
                        r.attributeChanged.hasOwnProperty(t) ||
                          (r.attributeChanged[t] = []);
                      }));
              }
              ...
              this.reordered &&
                (this.getOldPreviousSibling = t.getOldPreviousSibling.bind(t));
            }
            return (
              (t.prototype.getOldParentNode = function (t) {
            ...
            return (
              ...
              (t.prototype.toString = function () {
                return "class" === this.attrName && this.contains
                  ...
                  ? this.contains
                    ? "[" + this.attrName + "~=" + n(this.attrValue) + "]"
                    : "attrValue" in this
                    ? "[" + this.attrName + "=" + n(this.attrValue) + "]"
                    : "[" + this.attrName + "]"
                  : "#" + this.attrValue;
          ...
          b = (function () {
            ...
            return (
              ...
              (t.prototype.isMatching = function (e) {
                ...
                for (
                  var s = i.querySelectorAll(selector);
                  s[++o] && s[o] != n;
              ...
              (t.prototype.wasMatching = function (t, e, r) {
                ...
                for (var s = 0; s < this.qualifiers.length; s++) {
                  var a = this.qualifiers[s],
                    u = i[s];
                  if (
                    (void 0 === u && (u = t.getAttribute(a.attrName)),
                    !a.matches(u))
                  )
                    return !1;
                }
              ...
              (t.parseSelectors = function (e) {
                function r() {
                  i && (o && (i.qualifiers.push(o), (o = void 0)), a.push(i)),
                    (i = new t());
                }
                function n() {
                ...
                for (
                  var i,
                    ...
                    a = [],
                    u = /\s/,
                    c = "Invalid or unsupported selector syntax.",
                    d = 1,
                    h = 2,
                    l = 3,
                    p = 4,
                  ...
                  switch (x) {
                    ...
                    case h:
                      ...
                      if ("." == T) {
                        n(), (o.attrName = "class"), (o.contains = !0), (x = p);
                        break;
                      }
                      if ("#" == T) {
                        n(), (o.attrName = "id"), (x = p);
              ...
              (t.matchesSelector = (function () {
                ...
                return "function" == typeof t.webkitMatchesSelector
          ...
          _ = (function () {
            function t(e) {
              ...
              (this.connected = !1),
                ...
                t.createQueryValidator &&
                  (this.queryValidators = this.options.queries.map(function (
                    e
                  ) {
            ...
            return (
              (t.createObserverOptions = function (t) {
                function e(t) {
                  if (!n.attributes || r) {
                    if (((n.attributes = !0), (n.attributeOldValue = !0), !t))
              ...
              (t.validateOptions = function (e) {
                ...
                for (
                  ...
                  if (a.all) {
                    ...
                    var u = { attribute: i(a.attribute) };
                    if (
                      ((u.elementFilter = b.parseSelectors(
                        "*[" + u.attribute + "]"
                      )),
                    ...
                    if (
                      (a.hasOwnProperty("elementAttributes") &&
                        ((u.attributeList = o(a.elementAttributes)), c--),
                      c > 1)
                    )
                      throw Error(
          ...
          Array.from ||
            (Array.from = (function () {
              var t = Object.prototype.toString,
                e = function (e) {
                  return (
                    "function" == typeof e || "[object Function]" === t.call(e)
                  );
                },
                r = function (t) {
                  var e = Number(t);
              ...
              return function (t) {
                ...
                for (
                  var a,
                    u = i(n.length),
                    c = e(r) ? Object(new r(u)) : new Array(u),
                    d = 0;
                  u > d;
    ...
    26: [
            ...
            function t(t, e, r) {
              if (t) {
                ...
                if (
                  ...
                  !window.vds.impCtrlDua ||
                    (window.vds.impCtrlDua &&
                      Date.now() - window.grImpCtrl <= window.vds.impCtrlDua))
                ) {
                ...
                var a = [
                  { element: "*" },
                  {
                    element: "*",
                    elementAttributes:
                      "data-growing-title src data-gio-imp-track",
                  },
                ];
                r && (a = a.concat(r)),
              ...
              (t.prototype.serializeNode = function (t, e, r, c) {
                ...
                if (void 0 === e) {
                  ...
                  for (
                    ...
                    d && "BODY" !== d.tagName && "HTML" !== d.tagName;

                  ) {
                    var h = "/" + d.tagName.toLowerCase(),
                      l = d.getAttribute("id");
                    if (
                      (l && null === l.match(/^[0-9]/) && (h += "#" + l),
                ...
                switch (
                  ...
                  case 3:
                    if ("/" === e || 0 === t.textContent.trim().length)
                      return null;
                    (g.textContent = t.textContent
                      .replace(/[\n \t]+/g, " ")
                      .trim()),
                      g.textContent.length > 0 &&
                        ((g.leaf = !0),
                  ...
                  case 1:
                    ...
                    if (
                      ((g.tagName = w.tagName),
                      (g.attributes = { any: w.hasAttributes() }),
                      this.appendDataAttrs(g, w),
                      (e += w.tagName.toLowerCase()),
                      w.hasAttribute("id") &&
                        null === w.getAttribute("id").match(/^[0-9]/) &&
                        (e += "#" + w.getAttribute("id")),
                    ...
                    w.hasAttribute("href") &&
                      (g.attributes.href = w.getAttribute("href"));
                    var b,
                      y = !0;
                    if (((e += "/"), w.childNodes.length > 0)) {
                      if (
                        ((g.childNodes = []),
                        w.hasAttribute("growing-ignore") ||
                          w.hasAttribute("data-growing-ignore"))
                      )
                        return null;
                      w.hasAttribute("data-growing-container") &&
                        (g.isContainer = !0);
                      var _,
                        I,
                        S = 0,
                      ...
                      for (var N = w.firstChild; N; N = N.nextSibling) {
                        if (
                          ((_ = w.hasAttribute("data-growing-info")
                            ? w.getAttribute("data-growing-info")
                            : null),
                          (I = w.hasAttribute("data-growing-idx")
                            ? parseInt(w.getAttribute("data-growing-idx"))
                            : -1),
                          1 === N.nodeType)
                        ) {
                          if (1 === n[N.tagName]) {
                          ...
                          if (
                            N.hasAttribute("growing-ignore") ||
                            N.hasAttribute("data-growing-ignore")
                          )
                            continue;
                          if (
                            O &&
                            -1 !== a.indexOf(N.tagName) &&
                            ((y = !1), !N.children || 0 === N.children.length)
                          )
                            continue;
                          -1 !== i.indexOf(N.tagName) && ((S += 1), (I = S)),
                            N.hasAttribute("data-growing-idx") &&
                              ((S = parseInt(
                                N.getAttribute("data-growing-idx")
                              )),
                              (I = S)),
                            N.hasAttribute("data-growing-info") &&
                              (_ = N.getAttribute("data-growing-info"));
                        }
                        var x = this.serializeNode(
                          N,
                          e,
                          S > 0 && I > 0 ? S : r,
                          _ || c
                        );
                        if (null === x) 3 != N.nodeType && (y = !1);
                          ...
                          if (
                            (0 === w.offsetWidth || 0 === w.offsetHeight) &&
                            "A" !== w.tagName &&
                            "BUTTON" !== w.tagName
                          )
                            return null;
                    ...
                    if (y)
                      if (
                        ((g.leaf = !0),
                        "IMG" === w.tagName &&
                          (delete g.attributes.href,
                          w.src &&
                            -1 === w.src.indexOf("data:image") &&
                            (g.attributes.href = w.src)),
                        w.hasAttribute("data-growing-title") &&
                          w.getAttribute("data-growing-title").length > 0)
                      )
                        g.text = w.getAttribute("data-growing-title");
                      else if (
                        w.hasAttribute("title") &&
                        w.getAttribute("title").length > 0
                      )
                      ...
                      w.hasAttribute("data-growing-idx") &&
                        (g.idx = parseInt(w.getAttribute("data-growing-idx"))),
                        w.hasAttribute("data-growing-info") &&
                          (g.obj = w.getAttribute("data-growing-info"));
                    }
                    g.path = e.slice(0, -1);
                }
                return g;
              ...
              (t.prototype.serializeAddedAndMoved = function (t, e, r) {
                ...
                s.forEach(function (t) {
                  if (t && 1 !== n[t.tagName]) {
                    ...
                    if (
                      ...
                      if (
                        !r ||
                        (-1 === r.toLowerCase().indexOf("clock") &&
                          -1 === r.toLowerCase().indexOf("countdown") &&
                          -1 === r.toLowerCase().indexOf("time"))
                      )
                        if (
                          !i ||
                          (-1 === i.toLowerCase().indexOf("clock") &&
                            -1 === i.toLowerCase().indexOf("countdown") &&
                            -1 === i.toLowerCase().indexOf("time"))
                        )
                          if (e.getAttribute("data-countdown"));
                          else if (o && -1 !== o.indexOf("daterangepicker"));
                          else if (
                            t.hasAttribute("growing-ignore") ||
                            t.hasAttribute("data-growing-ignore")
                          );
                          else {
                            for (
                              ;
                              ...
                              "BODY" !== e.tagName &&
                              !e.hasAttribute("growing-ignore") &&
                              !e.hasAttribute("data-growing-ignore");
                ...
                return (
                  c.forEach(function (t) {
                    for (
                      var e = void 0, r = t;
                      r && "BODY" !== r.tagName && -1 === i.indexOf(r.tagName);
                ...
                (!window.vds.impCtrlDua ||
                  ...
                  setTimeout(function () {
                    var t = e.serializeAddedAndMoved(n, [], []),
                      ...
                      o = t.cstm || [],
                      s = [].concat(
                        i.attributeChanged["data-growing-title"],
                        i.attributeChanged.src,
                        i.attributeChanged["data-gio-imp-track"]
                      );
                    if (s && s.length > 0) {
                    ...
                    e.mirror.applyChanged([], { imp: r, cstm: o });
                  }, 10);
              }),
              t
            );
      ...
      { "../tools/utils.coffee": 18, "./mutation-summary": 24 },
    ],
    27: [
      function (t, e, r) {
        var n,
      ...
      { "../../core/info/dom_info": 10, "./gr_user_info": 28 },
    ],
    28: [
      function (t, e, r) {
        var n,
        ...
        (n = t("../../core/info/gr_user_info")),
          (i = (function (t) {
            ...
            return (
              o(e, t),
              (e.prototype.duration10year = 31536e4),
              (e.prototype.duration30min = 1800),
              ...
              (e.prototype.vid = function () {
                return this.userId
                  ? this.userId
                  : ((this.userId = this.cookie.getItem("gr_user_id")),
                    this.userId
                      ? this.cookie.setItem(
                          "gr_user_id",
                          this.userId,
              ...
              (e.prototype.hasSid = function () {
                ...
                return (
                  ...
                  this.sessionId &&
                  this.lastUpdated &&
                  e - this.lastUpdated < this.duration15min
                    ? !0
                    : ((r = this.currentSessionId()),
                      (t = r[0]),
                      (n = r[1]),
              ...
              (e.prototype.sid = function () {
                ...
                return (
                  ...
                  this.sessionId &&
                  this.lastUpdated &&
                  t - this.lastUpdated < this.duration1min
                    ? this.sessionId
                    : (this.sessionId ||
                        ((this.sessionId = this.guid()), (r = !1)),
              ...
              (e.prototype.last_sent_sid_with_cs1 = function () {
                return this.cookie.getItem(
                  window.vds.accountId + "_gr_last_sent_sid_with_cs1"
                );
              }),
              (e.prototype.last_sent_cs1 = function () {
                return this.cookie.getItem(
                  window.vds.accountId + "_gr_last_sent_cs1"
                );
              }),
              ...
              (e.prototype.clearCs1 = function () {
                ...
                return (
                  (e = this.cookieDomain()),
                  (t = window.vds.accountId),
                  this.cookie.removeItem(t + "_gr_cs1", "/", e)
                );
              }),
              (e.prototype.currentSessionId = function (t) {
                var e, r, n;
                return (
                  null == t && (t = window.vds.accountId),
                  (n = this.cookie.getItem(t + "_gr_session_id") || ""),
                  (r =
                    "true" === this.cookie.getItem(t + "_gr_session_id_" + n)),
                  n &&
                    n.indexOf("_") >= 0 &&
                    ((e = n.split("_")),
                    (n = e[0]),
              ...
              (e.prototype.updateSessionId = function (t, e, r) {
                var n;
                return (
                  this.lastSessionId !== t && this.visitorVar && (n = !0),
                  t
                    ? (r || (r = window.vds.accountId),
                      (this.lastUpdated = +Date.now()),
                      (this.lastSessionId = t),
                      this.updateSessionIdSendStatus(e, t, r),
                      this.cookie.setItem(
                        r + "_gr_session_id",
                        t,
                        this.duration30min,
                      ...
                      n && this.currentSessionId()[0]
                        ? window.gio("visitor.set", this.visitorVar)
                        : void 0)
                    : (console && console.error("sid shoud not be empty!"),
                      (this.sessionId = this.guid()),
                      void this.updateSessionId(this.sessionId, e, r))
                );
              }),
              (e.prototype.updateSessionIdSendStatus = function (t, e, r) {
                var n, i, o, s;
                for (
                  null == r && (r = window.vds.accountId),
                    o = this.cookie.keys(),
                    n = 0,
                    s = o.length;
                  s > n;
                  ...
                  if (
                    ((i = o[n]),
                    i.match(/.*_gr_session_id_/) &&
                      i.slice(i.lastIndexOf("_") + 1) !== e)
                  ) {
                    this.cookie.removeItem(i, "/", this.cookieDomain());
                    break;
                  }
                return this.cookie.setItem(
                  r + "_gr_session_id_" + e,
                  t,
                  this.duration30min,
                  "/",
    ...
    29: [
      function (t, e, r) {
        ...
        (i = t("./observer/dom_observer")),
          ...
          (c = void 0),
          9 > a ||
            ((window.MutationObserver = t("mutation-observer")),
            (c = t("tree-mirror"))),
          (o = (function (t) {
            function e() {
              (this.defaultSamplingFunc = h(this.defaultSamplingFunc, this)),
    ...
    30: [
      function (t, e, r) {
        ...
        if (
          ...
          (s = new n()),
          (window._gr_support_circle_pop_out = !0),
          !window._disable_js_vds &&
            ("boolean" != typeof window.webViewRequestSend ||
              window.webViewRequestSend ||
              (!window._vds_ios && !window._vds_bridge)) &&
            (window._vds_hybrid ||
          ...
          for (
            window.grSdkInstalled = !0,
              c = [],
              window.gio && window.gio.web
                ? (c = c.concat(window.gio.web))
                : ((null != (d = window.gio) ? d.q : void 0) &&
                    (c = c.concat(window.gio.q)),
            ...
            (u = c[o]), null != s && s.apply.apply(s, u);
          (i = function () {
            var t;
            return (
            ...
            (window.gio = function () {
              var t, e, r, n, i, o;
              for (
                (window._vds_bridge || window._vds_ios) &&
                  1 === window.gioGlobalArray.length &&
                  window.gio &&
                  window.gio.hybrid &&
                  window.gio.hybrid.push(arguments),
            ...
            (window._vds = {
              push: function () {
                var t, e, r, n, i;
                for (
                  n = window.gioGlobalArray, i = [], e = 0, r = n.length;
                  r > e;
                  e++
                )
                  (t = n[e]), i.push(t.push.apply(t, arguments));
                return i;
              },
              track: function () {
                var t, e, r, n, i;
                for (
                  ...
                  (t = n[e]), i.push(t.track.apply(t, arguments));
                return i;
              },
            });
        }
            ...
            return (
              ...
              (e.prototype.blind = function () {
                ...
                return (
                  ...
                  window.vds.sampling &&
                    (a
                      .functionDeserialization(window.vds.sampling_func)
                      .call(this) ||
                      (t = !0)),
                  (window.grBlind = t),
                  t
          ...
          (i = (function () {
            ...
            return (
              ...
              (t._checkingImpSetting = function () {
                return "undefined" == typeof this.impSetting() ||
                  null === this.impSetting()
                  ? t._fetchServerSetting()
                  : "false" === this.impSetting() || this.impSetting() === !1
                  ? (window.vds.imp = !1)
                  : void 0;
              }),
              (t._fetchServerSetting = function () {
                var t, e, r;
                return (
                  (r = (null != (t = window.vds) ? t.zone : void 0)
                    ? "-" + window.vds.zone
                    : ""),
                  (e =
                    ("https:" === document.location.protocol
                  ...
                  s.sendRequest(
                    ...
                    (function (t) {
                      return function (t) {
                        var e;
                        return (
                          (e = (null != t ? t.responseText : void 0)
                            ? JSON.parse(t.responseText).imp
                            : !0),
                          n.set(
                            "gr_imp_" + s.hashCode(window.vds.accountId),
                            e
                          ),
                          (window.vds.imp &= e),
                          window.vds.imp
                            ? void 0
                            : window._vds.push(["deregisterDomObserver"])
                        );
                      };
                    })(this)
                  )
    ...
    33: [
            ...
            : ((n = !0),
              ...
              "ArrayBufferView" in window ||
                (-1 !== d.indexOf("Android")
                  ? (n = !1)
                  : -1 !== d.indexOf("CPU OS ")
                  ? -1 !== d.indexOf("CPU OS 6_")
                    ? (n = !1)
                    : -1 !== d.indexOf("CPU OS 5_")
                    ? (n = !1)
                    : -1 !== d.indexOf("CPU OS 4_")
                    ? (n = !1)
                    : -1 !== d.indexOf("CPU OS 3_") && (n = !1)
                  : -1 !== d.indexOf("CPU iPhone OS ")
                  ? -1 !== d.indexOf("iPhone OS 6_")
                    ? (n = !1)
                    : -1 !== d.indexOf("iPhone OS 5_")
                    ? (n = !1)
                    : -1 !== d.indexOf("iPhone OS 4_") && (n = !1)
                  : -1 !== d.indexOf("Intel Mac OS X") &&
                    (-1 !== d.indexOf("Mac OS X 10_6")
                      ? (n = !1)
                      : -1 !== d.indexOf("Mac OS X 10_7") && (n = !1)))),
          (i = (function () {
            function t(t, e) {
              (this.user = t),
                (this.callback = e),
                (this.setListener = l(this.setListener, this)),
                (this.dispathMessage2Listener = l(
                  this.dispathMessage2Listener,
                  this
                )),
                (this.dispatchEvents = l(this.dispatchEvents, this)),
                (this.imgSendClear = l(this.imgSendClear, this)),
                (this.addRealTimeMessageCallBack = l(
                  this.addRealTimeMessageCallBack,
                  this
                )),
                (this.send = l(this.send, this)),
                (this.listeners = []),
                (this.typeListAccepted = [
                  "page",
                  "vst",
                  "clck",
                  "imp",
            ...
            return (
              ...
              (t.prototype.getUrlMap = function (t) {
                ...
                return (
                  (r =
                    t.zone && "api.growingio.com" === t.host
                      ? t.scheme + ("api-" + t.zone + ".growingio.com")
                      : t.scheme + t.host),
              ...
              (t.prototype.connect = function (t) {
                return (
                  ...
                  "function" == typeof this.callback
                    ? this.callback(this.user, this.send)
                    : void 0
                );
              }),
              (t.prototype.send = function (t, e) {
                ...
                if (
                  ...
                  try {
                    if (
                      ((h = "pv" === e && 2 === t.length ? t[0].s : ""),
                      (r =
                        "undefined" == typeof Uint8Array ||
                        null === Uint8Array ||
                        a
                          ? window.XMLHttpRequest && 7 !== s && !a
                            ? u.compressToUTF16(JSON.stringify(t))
                            : u.compressToEncodedURIComponent(JSON.stringify(t))
                          : u.compressToUint8Array(JSON.stringify(t))),
                      this.sendRemote(r, e, h),
                      this.typeListReceivedValid.length >= 0 &&
                        this.setRealTimeMessageCallBack)
                    )
                      for (i = 0, o = t.length; o > i; i++)
                        (c = t[i]),
                          (d = c.t),
                          p.call(this.typeListReceivedValid, d) >= 0 &&
                            this.setRealTimeMessageCallBack(c);
                    ...
                    return (n = l), console && console.warn(n);
                  }
              }),
              (t.prototype.addRealTimeMessageCallBack = function (t, e) {
                ...
                try {
                  if (Array.isArray(t))
                    for (i = 0, o = t.length; o > i; i++)
                      (n = t[i]),
                        p.call(this.typeListAccepted, n) >= 0 &&
                          this.typeListReceivedValid.push(n);
                  else {
                    if (
                      ((s = t.toString()),
                      !(p.call(this.typeListAccepted, s) >= 0))
                    )
              ...
              (t.prototype.sendRemote = function (t, i, o) {
                var u, c, d;
                return (
                  this.urlMap || (this.urlMap = this.getUrlMap(window.vds)),
                  (d = this.urlMap[i]),
                  (window.grWaitTime = +Date.now() + 300),
                  "" !== o && (this.sendVisitTimeout += 300),
                  window.XMLHttpRequest && 7 !== s && !a
                    ? ((u = new XMLHttpRequest()),
                      "withCredentials" in u
                        ? (u.open("POST", d + "?stm=" + +Date.now(), !0),
                          (u.withCredentials = !0),
                          (u.onreadystatechange = (function (t) {
                            return function () {
                              return 4 === u.readyState &&
                                ("" !== o && (t.sendVisitTimeout -= 300),
                                t.removeAjax(u),
                                (window.grWaitTime = +Date.now() + 10),
                                o && "" !== o && 200 === u.status)
                                ? t.user.updateSessionIdSendStatus(!0, o)
                                : void 0;
                            };
                          })(this)),
                          u.send(
                    ...
                    : ("http:" === document.location.protocol &&
                        (d = d.replace("https://", "http://")),
                      (c = d + "?data=" + t + "&stm=" + +Date.now()),
                      c.length <= 2036 && this.imgSend(c, o)),
                  (window.trackHostUrl = d)
                );
              }),
                  ...
                  (n.onload = (function (t) {
                    return function () {
                      return (
                        t.imgSendClear(n, e),
                        e && "" !== e
                          ? t.user.updateSessionIdSendStatus(!0, e)
                          : void 0
                      );
                    };
                  })(this)),
              ...
              (t.prototype.dispatchEvents = function (t) {
                var e, r;
                for (e = 0, r = []; e < t.length; )
                  this.dispathMessage2Listener(t[e]), r.push(e++);
                return r;
              }),
              (t.prototype.dispathMessage2Listener = function (t) {
                var e, r;
                for (e = 0, r = []; e < this.listeners.length; )
                  this.listeners[e](t), r.push((e += 1));
                return r;
              }),
      ...
      { "../core/tools/utils": 18, lzstring: 22 },
    ],
  },
  {},
  [30]
